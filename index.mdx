...
<div className="mx-auto flex w-full max-w-6xl flex-col gap-24 px-6 py-16 sm:py-24">
  ...
  <section className="flex flex-col items-center text-center gap-8">
    ...
    {/* Every browser shown is supported. Chromium and Gecko forks are
        auto-located from the user's system and run with the same HMR workflow.
        Safari is supported too, but it is the one target with platform
        requirements worth surfacing on the hero (macOS + Xcode). */}
    <p className="ext-dock-note">
      Chrome, Edge, Firefox, and their Chromium/Gecko forks are fully
      supported. Safari is supported on macOS (requires Xcode).
    </p>
    ...
    <div className="flex flex-wrap items-center justify-center gap-3">
      ...
      <a
        href="/docs/getting-started/immediately"
...
<section className="flex flex-col items-center text-center gap-8">
  ...
  <div className="w-full max-w-5xl">
    <iframe
      ...
      src="https://www.youtube-nocookie.com/embed/FYZABzKBNXc?autoplay=1&mute=1&loop=1&playlist=FYZABzKBNXc&controls=0&rel=0&playsinline=1"
    ...
    <div className="ext-feature-grid">
      ...
      >
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
            Start with React, Preact, Vue, Svelte, TypeScript, or JavaScript. Keep one
  ...
  <section className="flex flex-col gap-10">
    <div className="text-center max-w-3xl mx-auto">
      ...
      <p className="text-gray-600 dark:text-gray-300 mt-3 text-lg">
        ...
        TypeScript, WebAssembly, or JavaScript.
      </p>
    </div>
...
<section className="flex flex-col items-center text-center gap-6">
  ...
  <p className="text-sm text-gray-500 dark:text-gray-400 flex items-center justify-center gap-2 flex-wrap">
    ...
    <span>through its open source program.</span>
  </p>
  <a
  ...
  <section className="flex flex-col gap-8 max-w-3xl mx-auto w-full">
    ...
    <AccordionGroup>
      ...
      <Accordion title="How do I migrate from a custom webpack or Vite setup?">
        ...
        rest. Your React/Preact/Vue/Svelte/TS code works without rewriting.
      </Accordion>
      <Accordion title="Does Extension.js work with monorepos and environment variables?">
        ...
        `pnpm-workspace.yaml`). Path resolution
      ...
      <Accordion title="Does Extension.js support Safari?">
        Yes. `--browser=safari` works with `build` and
        `dev` on macOS: Extension.js converts your extension with Xcode's
        `safari-web-extension-converter` and builds a Safari app. It requires
        full Xcode, is macOS-only, and has no live reload yet. See
        [Building Safari extensions](/docs/browsers/safari) for setup and the
        current limitations.
      </Accordion>
      ...
      <Accordion title="How do I move an existing project to Extension.js?">
        ...
        `package.json` scripts. See [Extension configuration](/docs/features/extension-configuration)
        for the build defaults and [Get started immediately](/docs/getting-started/immediately)
        to run your project in one command.
      </Accordion>
    </AccordionGroup>
  </section>
