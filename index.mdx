  ...
  <section className="flex flex-col items-center text-center gap-8">
    ...
    <div className="ext-dock mx-auto w-full">
      <div className="ext-dock-row ext-dock-row-top">
        <div className="ext-dock-tile" data-tier="fork">
          <img
            src="https://media.extension.land/logos/browsers/brave.svg"
            alt="Brave"
            style={{ padding: "5%" }}
          />
          <span className="ext-dock-badge ext-dock-badge-fork">Fork</span>
        </div>
        ...
        >
          <img
            ...
            style={{ padding: 0 }}
          />
          <span className="ext-dock-badge ext-dock-badge-alpha">Alpha</span>
        </div>
      </div>
    ...
    {/* Support-tier legend for the browser dock above. Stable tiles carry no
        badge; forks (auto-located, bring-your-own binary) and the Safari alpha
        are labelled so the hero does not imply equal maturity across targets. */}
    <div className="ext-dock-legend" aria-hidden="true">
      <span className="ext-dock-legend-item">
        <span className="ext-dock-legend-dot ext-dock-legend-dot-stable" />
        Stable — Chrome, Edge, Firefox, Chromium
      </span>
      <span className="ext-dock-legend-item">
        <span className="ext-dock-legend-dot ext-dock-legend-dot-fork" />
        Fork — auto-located, or bring your own binary
      </span>
      <span className="ext-dock-legend-item">
        <span className="ext-dock-legend-dot ext-dock-legend-dot-alpha" />
        Alpha — Safari (macOS + Xcode)
      </span>
    </div>
  ...
  <section className="flex flex-col gap-8 max-w-3xl mx-auto w-full">
    ...
    <AccordionGroup>
      ...
      <Accordion title="Does Extension.js support Safari?">
        Yes, as an alpha target. `--browser=safari` works with `build` and
        ...
        full Xcode, is macOS-only, and has no live reload yet, so treat it as
        experimental — Chrome, Edge, and Firefox are the stable targets. See
