...
<div className="mx-auto flex w-full max-w-6xl flex-col gap-24 px-6 py-16 sm:py-24">
  ...
  <section className="flex flex-col items-center text-center gap-8">
    ...
    {/* Every browser shown is fully supported (Chromium and Gecko forks are
        auto-located from the user's system and run with the same HMR workflow).
        Safari is the one exception — an alpha target — so it is the only
        maturity note surfaced on the hero. */}
    <p className="ext-dock-note">
      Chrome, Edge, Firefox, and their Chromium/Gecko forks are fully
      supported. Safari is in alpha (macOS + Xcode).
    </p>
  ...
  <div className="ext-migrate-callout">
    <div>
      ...
      <p className="text-gray-600 dark:text-gray-400 mt-3 text-base sm:text-lg max-w-2xl">
        ...
        rewriting. The work is replacing the bundler config and moving
        generated manifests back to a real manifest.json.
      </p>
    </div>
