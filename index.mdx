...
description: "Build browser extensions for Chrome, Edge, and Firefox from one project. Extension.js handles manifest compilation, browser-specific output, fast reloads on save, and store-ready packaging."
mode: "custom"
---
