...
- [调试总览](/zh-Hans/docs/debugging)：运行中会话的完整控制面。
- [可用浏览器](/zh-Hans/docs/browsers/browsers-available)：挑一个能加载你的 manifest 的目标。
- [跨浏览器兼容性](/zh-Hans/docs/features/cross-browser-compatibility)：让同一份 manifest 在各个引擎上都能用。
