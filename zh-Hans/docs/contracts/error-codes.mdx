...
这张表随 `extension-develop/contract/codes.json` 一起发布，参见 [结果信封](/zh-Hans/docs/contracts/result-envelope)。
...
- 在 [结果信封](/zh-Hans/docs/contracts/result-envelope) 中了解错误码会流经哪些地方。
- 在 [生命周期流](/zh-Hans/docs/contracts/lifecycle-stream) 中实时观察失败帧。
