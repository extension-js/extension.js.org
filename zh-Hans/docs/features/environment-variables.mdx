...
`EXTENSION_TELEMETRY=1` 同时也是 CI 中的显式开启方式：在 CI 里遥测默认是关闭的。完整退出契约请参见[遥测与隐私](/docs/features/telemetry-and-privacy)。
...
固定语料库的工作方式请参见[模板](/docs/getting-started/templates)。
