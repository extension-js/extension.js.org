...
该目录总是以你请求的目标命名，即使 `dev` 作为回退启动了 Chromium 家族中的另一个二进制文件也是如此。参见[请求的目标 vs. 启动的二进制文件](/zh-Hans/docs/browsers/browsers-available#requested-target-vs-launch-binary)。
...
- 通过[路径解析](/zh-Hans/docs/features/path-resolution) 了解资产/产物映射细节。
