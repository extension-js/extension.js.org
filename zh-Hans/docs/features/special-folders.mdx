...
- 进一步了解[页面重载与热模块替换 (HMR)](/zh-Hans/docs/features/reload-and-hmr)。
- 在 [Content scripts](/zh-Hans/docs/implementation-guide/content-scripts) 中了解挂载契约。
- 浏览[模板](/zh-Hans/docs/getting-started/templates) 以快速搭建你的下一个扩展。
