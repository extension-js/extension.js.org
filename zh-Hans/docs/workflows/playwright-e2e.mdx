...
把这份契约作为就绪和失败的真相来源。完整的字段参考，包括 `extensionId`、`profilePath`、`cdpPort` 以及各种错误状态，见 [ready.json](/zh-Hans/docs/contracts/ready-json)。
...
- 让命令工作流与 [dev](/zh-Hans/docs/commands/dev) 和 [build](/zh-Hans/docs/commands/build) 保持一致。
