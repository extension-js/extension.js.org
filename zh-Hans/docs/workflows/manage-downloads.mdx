...
- 在[录制屏幕](/zh-Hans/docs/workflows/record-the-screen)中用这个 API 保存录制的媒体。
- 在[安全检查清单](/zh-Hans/docs/workflows/security-checklist)中审查 `downloads` 权限。
- 回顾[开发期更新行为](/zh-Hans/docs/workflows/dev-update-behavior)了解 popup 的重载规则。
