...
- 查看 [跨浏览器兼容性](/docs/features/cross-browser-compatibility) 了解一份 MV3 manifest 如何发布到 Chrome、Firefox 等浏览器。
- 从[模板](/docs/getting-started/templates)脚手架出一个 MV3 就绪的项目：[React](/docs/getting-started/templates/react)、[TypeScript](/docs/getting-started/templates/typescript)、[Svelte](/docs/getting-started/templates/svelte) 等。
