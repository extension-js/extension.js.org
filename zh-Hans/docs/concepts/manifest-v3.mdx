...
完整模式见 [`web_accessible_resources` 实现](/zh-Hans/docs/implementation-guide/web-accessible-resources)，其中包含把一个扩展 URL 注入 content script 的做法。
...
按 API 的参考见 [权限与宿主权限](/zh-Hans/docs/implementation-guide/permissions-and-host-permissions)。
...
- 阅读 [权限与宿主权限](/zh-Hans/docs/implementation-guide/permissions-and-host-permissions)。
- 阅读 [背景脚本](/zh-Hans/docs/implementation-guide/background) 与 [Content scripts](/zh-Hans/docs/implementation-guide/content-scripts)。
...
- 查看 [按浏览器的 manifest 字段](/zh-Hans/docs/features/browser-specific-fields) 了解前缀化的 manifest 键。
- 查看 [跨浏览器兼容性](/zh-Hans/docs/features/cross-browser-compatibility) 了解一份 MV3 manifest 如何发布到 Chrome、Firefox 等浏览器。
- 从[模板](/zh-Hans/docs/getting-started/templates)脚手架出一个 MV3 就绪的项目：[React](/zh-Hans/docs/getting-started/templates/react)、[TypeScript](/zh-Hans/docs/getting-started/templates/typescript)、[Svelte](/zh-Hans/docs/getting-started/templates/svelte) 等。
