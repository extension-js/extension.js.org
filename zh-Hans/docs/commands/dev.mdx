...
<Frame>
  <iframe
    ...
    src="https://www.youtube-nocookie.com/embed/Ee8R8tzYcW4?rel=0"
...
从 4.1.20 起，Safari 会话就是一个完整的 dev 会话。你在 Safari 设置中启用扩展之后，`extension logs` 可以读取它，控制通道会连上，每次保存都会在 Safari 中重载扩展。详见 [构建 Safari 扩展](/zh-Hans/docs/browsers/safari)。
...
<Frame>
  <iframe
    className="w-full aspect-video rounded-xl"
    src="https://www.youtube-nocookie.com/embed/ecqoWM0ct1Y?rel=0"
