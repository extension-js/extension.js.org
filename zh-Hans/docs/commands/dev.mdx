...
`--no-browser` 是无头、CI 与远程工作的运行模式，也是 [Playwright E2E](/docs/workflows/playwright-e2e) 工作流所依赖的 flag。它还有配置写法 `commands.dev.noBrowser: true`，以及环境变量写法 `EXTENSION_CLI_NO_BROWSER=1`。
