...
- 在 [`dev`](/zh-Hans/docs/commands/dev#automation-metadata-recommended-for-scriptsagents) 中了解 `doctor` 的起点——就绪契约。
- 通过 [调试](/zh-Hans/docs/debugging) 从健康的会话中流式读取扩展日志。
- 在 [全局 flag](/zh-Hans/docs/workflows/global-flags) 中查看共享 flag。
