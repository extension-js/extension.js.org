...
- 在 [Web-accessible 资源](/zh-Hans/docs/implementation-guide/web-accessible-resources) 中评估页面访问。
- 在 [消息通信](/zh-Hans/docs/implementation-guide/messaging) 中校验边界处理。
- 在 [安全清单](/zh-Hans/docs/workflows/security-checklist) 中执行发布前的检查。
- 在 [Manifest V3 故障排查](/zh-Hans/docs/concepts/manifest-v3) 中对比 `permissions` 与 `host_permissions` 的行为。
