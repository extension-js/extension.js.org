...
仓库：[extension-js/examples/newtab-sass](https://github.com/extension-js/examples/tree/main/examples/newtab-sass)
...
- 如果没有安装 `sass` 包，Extension.js 会发出警告，并把原始 Sass 源码原样复制到输出的 CSS 中，所以在你自己安装它之前，这些界面会显示为没有样式。

## 下一步

- 进一步了解 [CSS 模块](/zh-Hans/docs/languages-and-frameworks/css-modules)。
- 用 [Stylelint](/zh-Hans/docs/integrations/stylelint) 保证样式表质量。
