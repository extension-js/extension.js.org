...
- [获取你的 Chrome Web Store 凭据](/zh-Hans/docs/publishing/chrome-credentials)
- [获取你的 Firefox Add-ons 凭据](/zh-Hans/docs/publishing/firefox-credentials)
- [获取你的 Edge Add-ons 凭据](/zh-Hans/docs/publishing/edge-credentials)
...
<Steps>
  ...
  <Step title="编写 STORE.md">
    在第一次提交之前先写好 [STORE.md 元数据文件](/zh-Hans/docs/workflows/store-metadata)。
...
- 拿到凭据：[Chrome](/zh-Hans/docs/publishing/chrome-credentials)、
  [Firefox](/zh-Hans/docs/publishing/firefox-credentials)、
  [Edge](/zh-Hans/docs/publishing/edge-credentials)。
- 把这些书面材料写一次就够：
