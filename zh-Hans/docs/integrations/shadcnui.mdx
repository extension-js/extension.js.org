...
1. 设置 Tailwind 和 PostCSS（参见 [Tailwind CSS](/zh-Hans/docs/integrations/tailwindcss)）。
...
- 如果还没有，先设置 [Tailwind CSS](/zh-Hans/docs/integrations/tailwindcss)。
- 用 [ESLint](/zh-Hans/docs/integrations/eslint) 和 [Prettier](/zh-Hans/docs/integrations/prettier) 增加 lint 与格式化。
