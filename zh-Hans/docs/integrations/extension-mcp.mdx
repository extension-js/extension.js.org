...
- 把它与 Google 的 Chrome 调试服务器一起运行：[Chrome DevTools MCP](/zh-Hans/docs/integrations/chrome-devtools-mcp) 里有完整的能力对照表。
- 把文档也接入你的助手：[通过 MCP 与 llms.txt 提供 AI 访问](/zh-Hans/docs/ai-access)。
- 把同样的检查接入 CI：[CI 模板](/zh-Hans/docs/workflows/ci-templates)。
