...
<div className="mx-auto flex w-full max-w-6xl flex-col gap-24 px-6 py-16 sm:py-24">
  ...
  <section className="flex flex-col items-center text-center gap-8">
    ...
    <div className="flex flex-wrap items-center justify-center gap-3">
      ...
      <a
        href="/zh-Hans/docs/getting-started/immediately"
  ...
  <section className="flex flex-col gap-8 max-w-3xl mx-auto w-full">
    ...
    <AccordionGroup>
      <Accordion title="什么是浏览器扩展？">
        ...
        [什么是浏览器扩展？](/zh-Hans/docs/concepts/what-is-a-browser-extension)。
      </Accordion>
      <Accordion title="Extension.js 是 Chrome 扩展框架吗？">
        ...
        或 `--browser=edge` 选择目标。详见[可用浏览器](/zh-Hans/docs/browsers/browsers-available)。
      </Accordion>
      ...
      <Accordion title="Extension.js 支持 Manifest V3 吗？">
        ...
        常见踩坑请参见 [Manifest V3 排查](/zh-Hans/docs/concepts/manifest-v3)。
      </Accordion>
      <Accordion title="如何排查 Manifest V3 的 service worker 与权限问题？">
        ...
        Firefox 中 `declarative_net_request` 的差异。修复方法见 [Manifest V3 排查](/zh-Hans/docs/concepts/manifest-v3)。
      </Accordion>
      ...
      <Accordion title="Extension.js 可以免费使用吗？">
        ...
        [遥测合约](/zh-Hans/docs/features/telemetry-and-privacy)。
      </Accordion>
      <Accordion title="Extension.js 支持 Safari 吗？">
        支持。`--browser=safari` 可用于 macOS 上的 `build` 与 `dev`：
        Extension.js 会用 Xcode 的 `safari-web-extension-converter` 转换你的扩展并构建出
        Safari 应用。它需要完整的 Xcode，仅限 macOS，且暂时没有实时重载。安装步骤与当前限制请参见
        [构建 Safari 扩展](/zh-Hans/docs/browsers/safari)。
      </Accordion>
      <Accordion title="Extension.js 会给我的包体积加多少东西？">
        生产构建（`extension build`）只会输出扩展实际引用的代码。重载与 HMR 的胶水代码仅存在于开发构建中，生产产物里不包含它们。产物位于 `dist/<browser>` 下，方便你对比不同浏览器的体积。
      ...
      <Accordion title="如何从其他框架迁移过来？">
        ...
        把生成的 manifest 换回手写的、带[浏览器前缀键](/zh-Hans/docs/features/browser-specific-fields)的 `manifest.json`；
