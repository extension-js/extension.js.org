...
description: "Use WebAssembly modules in your browser extension without custom bundler setup, with async and sync loading patterns supported by Extension.js."
icon: "wasm"
