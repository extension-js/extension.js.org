...
description: "Use WebAssembly modules in Extension.js projects with built-in Rspack pipeline support for async wasm loading and compute-heavy extension features."
icon: "wasm"
keywords: ["extension.js", "extensions", "chrome", "firefox", "edge", "browser", "typescript", "javascript"]
---
...
- Learn how Extension.js works with [ECMAScript Modules](/languages-and-frameworks/ecmascript-modules).
