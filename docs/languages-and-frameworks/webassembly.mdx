---
title: 'WebAssembly'
description: 'Use WebAssembly modules in browser extensions without custom bundler setup. Extension.js ships built-in wasm support through its default Rspack pipeline.'
icon: 'microchip'
keywords:
  [
    'extension.js',
