---
title: "WebAssembly"
description: "Use WebAssembly in browser extensions with built-in Rspack support for async wasm, .wasm resolution, and runtime aliases without custom bundler setup."
icon: "wasm"
