...
- path aliases for common Wasm libraries (for example, ffmpeg for media processing, imagemagick for image manipulation, and tesseract for text recognition) so imports resolve correctly at runtime
