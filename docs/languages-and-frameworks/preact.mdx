...
![new-preact template screenshot](/images/examples/new-preact/screenshot.png)
...
![content-preact template screenshot](/images/examples/content-preact/screenshot.png)
...
- **Prompt to restart after install:** restart `extension dev` so the framework can reload refresh wiring cleanly.
