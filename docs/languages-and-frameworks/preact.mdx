...
description: 'Ship smaller extension UI bundles with Preact and keep a React-like developer experience. Extension.js auto-configures JSX transforms and compat aliases.'
icon: 'atom'
keywords:
  [
    'extension.js',
