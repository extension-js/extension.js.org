---
title: 'Preact'
description: 'Ship smaller extension UI bundles with Preact and Extension.js. Auto-configured JSX transforms, React compatibility aliases, and fast refresh during dev.'
icon: 'atom'
keywords:
  [
    'extension.js',
