...
Extension.js detects Preact from your dependencies and configures JSX/TSX transforms, React compatibility aliases (so React imports map to Preact), and fast-refresh support automatically.
