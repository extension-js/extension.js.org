---
title: "Preact"
description: "Ship smaller extension UI bundles with Preact using auto-detected React compatibility aliases, JSX handling, and refresh integration via Extension.js."
icon: "preact"
