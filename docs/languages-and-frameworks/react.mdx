---
title: 'React'
description: 'Build browser extension UIs with React and Extension.js. Auto-configured JSX/TSX transforms, React aliases, and development refresh integration out of the box.'
icon: 'atom'
keywords:
  [
    'extension.js',
