...
- If your project lacks optional refresh dependencies, Extension.js warns with the exact install command and continues without fast refresh, rather than installing them for you. It does not ask for a restart.
