---
title: "React in browser extensions"
description: "Build browser extension UIs for popup, sidebar, options, and content scripts using React with the default Extension.js pipeline and HMR support."
icon: "react"
keywords: ["extension.js", "extensions", "browser", "typescript", "javascript", "react", "rspack", "content script"]
---
