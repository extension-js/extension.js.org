...
description: "Build browser extension UIs with React using automatic JSX/TSX transforms, fast refresh, and templates for popups, content scripts, and new-tab pages."
icon: "react"
