---
title: "React"
description: "Build browser extension UIs with React using auto-detected JSX transforms, alias configuration, and React Refresh for new-tab and content-script entries."
icon: "react"
