---
title: 'CSS modules'
description: 'Scope styles by default with CSS Modules in Extension.js. Avoid naming collisions across popup, options, and content script surfaces with zero configuration.'
icon: 'layer-group'
keywords:
  [
    'extension.js',
