...
description: "Scope styles by default and avoid naming collisions across extension pages, options UIs, and popups using CSS modules in Extension.js projects."
icon: "cssModules"
keywords: ["extension.js", "react", "vue", "svelte", "preact", "rspack", "content script", "popup"]
---
...
- Learn more about [Sass and Sass modules](/languages-and-frameworks/sass).
- Learn more about [LESS and LESS modules](/languages-and-frameworks/less).
