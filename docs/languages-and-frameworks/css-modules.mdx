---
title: "CSS modules"
description: "Scope styles with zero-config CSS Modules using *.module.css for extension pages across React, Vue, Svelte, and Preact with framework usage examples."
icon: "cssModules"
