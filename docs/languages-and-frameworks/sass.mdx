...
description: "Style browser extensions with Sass, SCSS, and Sass modules including .module.scss support, installation steps, and template examples in Extension.js."
icon: "sass"
