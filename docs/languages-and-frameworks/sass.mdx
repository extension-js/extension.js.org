...
description: "Scale extension styling with Sass variables, nesting, and modules across popup, options, sidebar, and content script surfaces in Extension.js."
icon: "sass"
keywords: ["extension.js", "react", "vue", "svelte", "preact", "rspack", "stylelint", "content script"]
---
...
- Ensure stylesheet quality with [Stylelint](/integrations/stylelint).
