...
Sass Modules allow you to scope styles locally, just like CSS Modules. Use `.module.scss` or `.module.sass` to activate Sass Modules. This prevents naming conflicts in your stylesheets.
...
- In content scripts, Extension.js emits Sass as CSS assets for injection rather than module export maps.
