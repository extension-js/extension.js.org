...
description: 'Scale extension styling with Sass variables, nesting, and module-scoped styles. Extension.js supports .scss, .sass, and .module variants via Rspack.'
icon: 'droplet'
keywords:
  [
    'extension.js',
...
- In content scripts, Extension.js emits Sass as CSS assets for injection rather than providing JavaScript class-name mappings.
- If Sass tooling is missing, Extension.js installs the optional dependencies and asks for a restart.
