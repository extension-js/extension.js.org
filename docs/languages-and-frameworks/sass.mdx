...
description: 'Scale extension styling with Sass variables, nesting, and modules. Extension.js supports .scss, .sass, and scoped .module.scss files through Rspack builds.'
icon: 'droplet'
keywords:
  [
    'extension.js',
