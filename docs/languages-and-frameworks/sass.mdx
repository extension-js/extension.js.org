---
title: "Sass / Sass modules"
description: "Use Sass and Sass Modules for extension styling with variables, nesting, and scoped class names across React, Vue, Svelte, and content scripts."
icon: "sass"
