---
title: 'Sass and Sass modules in extensions'
description: 'Scale extension styling with Sass variables, nesting, and module-scoped styles. Extension.js supports .scss, .sass, and their .module variants via Rspack.'
icon: 'droplet'
keywords:
  [
    'extension.js',
...
Add Sass to an existing Extension.js project with the steps below.
...
Scope styles locally with Sass Modules, just like CSS Modules. Use `.module.scss` or `.module.sass` to activate scoping and prevent naming collisions in your stylesheets.
...
- In content scripts, Extension.js emits Sass as CSS assets for injection rather than providing importable class-name maps.
