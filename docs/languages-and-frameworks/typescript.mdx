---
title: 'TypeScript'
description: 'Build TypeScript browser extensions with zero bundler config. Extension.js compiles TS across background, content scripts, and pages via Rspack and SWC.'
icon: 'code'
keywords:
  [
    'extension.js',
