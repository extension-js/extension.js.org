...
Extension.js supports TypeScript across extension contexts (background, content scripts, and page scripts) using the default Rspack + SWC (Speedy Web Compiler) pipeline.
