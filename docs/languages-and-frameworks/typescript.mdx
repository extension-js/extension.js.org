---
title: 'TypeScript'
description: 'Build TypeScript browser extensions with zero custom bundler config. Extension.js supports TS across background, content scripts, and pages via Rspack and SWC.'
icon: 'code'
keywords:
  [
    'extension.js',
