...
description: "Write browser extensions in TypeScript across background scripts, content scripts, and UI pages with zero custom bundler configuration in Extension.js."
icon: "typescript"
