---
title: "TypeScript in browser extensions"
description: "Build TypeScript browser extensions with zero custom bundler wiring using Extension.js, including SWC compilation and type checking setup."
icon: "typescript"
