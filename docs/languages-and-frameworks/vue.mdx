...
Extension.js detects Vue from your dependencies and configures single-file component (SFC) compilation, framework aliases, and dev-time update behavior automatically. Scoped styles, the Composition API, and `<script setup>` all work without extra bundler wiring.
...
![new-vue template screenshot](/images/examples/new-vue/screenshot.png)
...
![content-vue template screenshot](/images/examples/content-vue/screenshot.png)
