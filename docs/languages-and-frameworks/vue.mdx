---
title: "Vue.js extensions"
description: "Build browser extension UIs with Vue single-file components, scoped styles, and auto-detected SFC compilation in the Extension.js build pipeline."
icon: "vue"
