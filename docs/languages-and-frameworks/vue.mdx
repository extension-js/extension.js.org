---
title: 'Vue.js'
description: 'Build extension UIs with Vue single-file components in Extension.js. Automatic SFC compilation, framework aliases, and development behavior out of the box.'
icon: 'code'
keywords:
  [
    'extension.js',
