---
title: "Vue.js in browser extensions"
description: "Build extension UIs with Vue single-file components for popup, sidebar, options, and content scripts using Extension.js without custom bundler setup."
icon: "vue"
keywords: ["extension.js", "typescript", "javascript", "vue", "rspack", "content script", "docs", "languages and frameworks"]
---
...
- Explore [Sass and Sass modules](/languages-and-frameworks/sass).
