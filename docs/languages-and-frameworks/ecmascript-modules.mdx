...
description: "Author extension code with modern import/export syntax across background, content scripts, and UI pages using Extension.js module resolution."
icon: "js"
