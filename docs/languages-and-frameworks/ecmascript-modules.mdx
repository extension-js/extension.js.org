...
description: "Use modern import/export syntax across all extension contexts with ESM support, MV3 service worker module type, and import.meta.env for environment access."
icon: "js"
