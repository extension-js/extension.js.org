...
description: 'Understand why Node core modules are not polyfilled by default in Extension.js and how to selectively add polyfills when browser-native APIs are not enough.'
icon: 'server'
keywords:
  [
    'extension.js',
