...
description: "Learn why Extension.js targets the browser runtime by default without Node polyfills and how to selectively polyfill Node core modules when needed."
icon: "node"
