...
description: "Understand Node API polyfill support in Extension.js browser extensions, when to use browser-native APIs first, and how to enable Node fallbacks."
icon: "node"
