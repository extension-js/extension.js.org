...
Setting `polyfill: true` in CLI/config enables `webextension-polyfill` (a compatibility shim that gives Chromium browsers access to the `browser.*` API namespace), not Node core module polyfills.
