...
description: "Selectively polyfill Node core modules in browser extensions using node-polyfill-webpack-plugin via extension.config.js when browser APIs are not enough."
icon: "node"
keywords: ["extension.js", "extensions", "browser", "typescript", "rspack", "content script", "docs", "languages and frameworks"]
---
...
- Learn how to customize [Rspack configuration](/features/rspack-configuration).
- Learn how to manage [extension configuration](/features/extension-configuration).
