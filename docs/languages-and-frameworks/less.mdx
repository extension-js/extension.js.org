...
description: 'Use Less and Less Modules across extension pages and UI components. Extension.js wires the preprocessor in Rspack and supports .less and .module.less.'
icon: 'droplet'
keywords:
  [
    'extension.js',
...
Scope class names locally with Less Modules, just like CSS Modules. This prevents naming collisions by default.
...
- In content scripts, Extension.js emits styles as CSS assets and injects them through its content-script CSS pipeline.
