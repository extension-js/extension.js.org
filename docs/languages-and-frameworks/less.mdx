...
description: 'Use Less and Less Modules across extension pages and UI components. Extension.js wires the preprocessor into Rspack and supports scoped .module.less files.'
icon: 'droplet'
keywords:
  [
    'extension.js',
