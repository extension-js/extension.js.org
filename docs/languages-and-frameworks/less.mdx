...
description: 'Use Less CSS and Less modules across browser extension pages and UI components. Extension.js configures the preprocessor in Rspack and supports .less and .module.less.'
icon: 'droplet'
keywords:
  [
    'less css',
