---
title: 'Svelte'
description: 'Build extension UIs with Svelte components in Extension.js. Automatic .svelte file resolution, loader setup, and client aliases with zero manual config.'
icon: 'puzzle'
keywords:
  [
    'extension.js',
