---
title: "Svelte extensions"
description: "Build browser extension UIs with Svelte components using automatic loader setup and template examples for new-tab and content-script extensions."
icon: "puzzle"
