---
title: "Svelte in browser extensions"
description: "Build extension UIs with Svelte components for popup, sidebar, options, and content script entry points using Extension.js framework wiring."
icon: "puzzle"
keywords: ["extension.js", "browser", "typescript", "react", "svelte", "content script", "popup", "docs"]
---
...
- Review the content-script contract in [Content scripts](/implementation-guide/content-scripts).
