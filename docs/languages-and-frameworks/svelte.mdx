...
description: 'Build extension UIs with Svelte components. Extension.js auto-configures .svelte file resolution, loader setup, and client aliases from your dependencies.'
icon: 'puzzle'
keywords:
  [
    'extension.js',
