...
description: 'Build extension UIs with Svelte components. Extension.js auto-configures .svelte resolution, loader setup, and Svelte client aliases from your dependencies.'
icon: 'puzzle'
keywords:
  [
    'extension.js',
