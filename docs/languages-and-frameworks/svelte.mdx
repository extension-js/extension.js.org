---
title: "Svelte"
description: "Build extension UIs with Svelte components using auto-detected loader wiring, .svelte resolution, and starter templates for pages and content scripts."
icon: "puzzle"
