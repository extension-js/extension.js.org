...
Access Extension.js documentation through two standard AI-accessible surfaces. This lets your editor and assistants answer questions grounded in the real docs instead of stale training data.
