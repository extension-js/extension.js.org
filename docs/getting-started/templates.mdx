...
Pick the stack default that matches your project. Each card scaffolds a minimal, runnable extension with a working `manifest.json`.
...
<CardGroup cols={2}>
  ...
  <Card title="React" href="/docs/getting-started/templates/react">
    <div className="flex items-center gap-4">
      ...
      />
      <span className="text-sm text-gray-600 dark:text-gray-300">
        Component-based UI with full MV3 support and HMR for popup and options.
      </span>
    </div>
  </Card>
</CardGroup>
