...
description: "Run existing browser extensions in minutes using extension dev with GitHub URLs, local paths, or ZIP archives from Chrome, Edge, and MDN samples."
icon: "fire"
