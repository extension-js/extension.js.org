...
description: 'Build and run a working browser extension in minutes using real-world samples. The fastest path to a running extension with Extension.js dev and create.'
icon: 'fire'
keywords:
  [
    'extension.js',
