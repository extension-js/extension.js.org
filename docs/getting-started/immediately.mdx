...
You have two common entrypoints. Point `extension dev` at a local folder you already cloned, or point it at a GitHub URL to let Extension.js fetch the sample for you.
