...
description: 'Scaffold a TypeScript browser extension for Chrome, Edge, and Firefox with strict types across popup, content scripts, and MV3 background workers.'
