...
description: 'Scaffold a Vue.js browser extension for Chrome, Edge, and Firefox with single-file components wired for popup, options, and content script contexts.'
