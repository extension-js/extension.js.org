...
description: 'Scaffold a Preact browser extension with the React API in a 3kB runtime, tuned for size-sensitive popups and content scripts on Chrome and Firefox.'
