...
description: "Step-by-step tutorial to build a GitHub search omnibox extension from scratch using extension create, a service worker, and live API suggestions."
icon: "flag-checkered"
