...
- `omnibox.keyword`: When you type `gh` in the address bar, the browser fires an omnibox event.
- `background.service_worker`: Listens to the omnibox event and handles the query.
