...
description: 'Build your first browser extension end-to-end with Extension.js. Create a GitHub search shortcut for the omnibox and learn the core dev workflow.'
icon: 'flag-checkered'
keywords:
  [
    'extension.js',
