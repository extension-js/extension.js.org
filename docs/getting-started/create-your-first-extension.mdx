...
Build your first browser extension end-to-end with a practical workflow. Create a GitHub search shortcut that runs from the browser omnibox (address bar) and learn the core Extension.js loop.
