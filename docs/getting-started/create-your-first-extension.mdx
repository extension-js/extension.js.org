...
description: "Build a GitHub search omnibox extension end-to-end in this step-by-step tutorial covering the core Extension.js workflow from scaffold to service worker."
icon: "flag-checkered"
keywords: ["extension.js", "extensions", "chrome", "browser", "manifest", "playwright", "service worker", "docs"]
---
...
Every extension starts with a manifest file. It defines metadata, permissions, and runtime files. Based on the [plan above](#the-plan), we will set the `gh` shortcut and add a service worker for user events.
...
- Create another extension with [templates](/getting-started/templates).
- Add automated checks with [Playwright E2E](/workflows/playwright-e2e).
- Review [Troubleshooting](/workflows/troubleshooting), [Security checklist](/workflows/security-checklist), and [Performance playbook](/workflows/performance-playbook) as your extension grows.
