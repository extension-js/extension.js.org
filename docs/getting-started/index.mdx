...
description: 'Ship your first browser extension quickly with Extension.js. Choose a learning path, explore starter templates, and level up with workflow guides.'
icon: 'rocket'
keywords:
  [
    'extension.js',
