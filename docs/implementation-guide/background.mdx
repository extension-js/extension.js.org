...
Here is an example of how to declare a background script in `manifest.json`:
...
- Use the background context as the privileged coordinator for messaging, storage, and browser API orchestration.
