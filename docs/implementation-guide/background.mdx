...
description: "Run extension-wide logic using MV2 background scripts or MV3 service workers with Extension.js compilation and browser-specific reload behavior."
icon: "layer-group"
