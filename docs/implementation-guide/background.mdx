...
description: "Run extension-wide logic with MV2 background scripts or MV3 service workers, covering lifecycle management, state rehydration, and dev reload behavior."
icon: "layer-group"
