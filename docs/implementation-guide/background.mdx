...
description: "Handle background scripts and MV3 service workers in Extension.js with manifest-driven entries, dedicated outputs, and browser-specific reload behavior."
icon: "layer-group"
keywords: ["extension.js", "extensions", "firefox", "browser", "manifest", "javascript", "hmr", "content script"]
---
...
- Persist durable runtime state with [Storage](/implementation-guide/storage).
- Coordinate contexts with [Messaging](/implementation-guide/messaging).
- Learn more about [JavaScript in development](/implementation-guide/javascript).
- Continue with [content scripts](/implementation-guide/content-scripts).
