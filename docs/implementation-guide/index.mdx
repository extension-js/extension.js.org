...
This section explains the contracts that matter when you author real extension features. It covers what `manifest.json` controls, which entrypoints Extension.js rewrites, and where special folders fit. It also clarifies which behaviors are safe for automation and where browser-extension constraints apply.

## Start by need

| Need                                                        | Read this first                                                                                 |
| ----------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| Understand how one manifest becomes browser-specific output | [manifest.json](/docs/implementation-guide/manifest-json)                                       |
