...
description: 'Build browser extension features with the Extension.js runtime model. Covers manifest contracts, entrypoints, special folders, and browser-specific constraints.'
icon: 'puzzle'
keywords:
  [
    'extension.js',
