...
Learn the contracts that matter when you author real extension features. Understand what `manifest.json` controls, which entrypoints Extension.js rewrites, and where special folders fit. Then decide which behaviors you can safely automate and which browser-extension constraints still apply.
