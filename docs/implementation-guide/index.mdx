...
Learn the contracts that matter when you author real extension features: what `manifest.json` controls, which entrypoints Extension.js rewrites, and where special folders fit. Understand which behaviors are safe to automate and which are bounded by browser-extension constraints.
