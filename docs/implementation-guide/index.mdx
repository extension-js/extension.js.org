...
This section explains the contracts that matter when you author real extension features. It covers what `manifest.json` controls, which entrypoints Extension.js rewrites, where special folders fit, and which behaviors are safe to automate vs. bounded by browser-extension constraints.
