---
title: "HTML"
description: "Build popup, options, side panel, devtools, and new-tab UIs with HTML entrypoints while Extension.js handles asset bundling and dev-time updates."
icon: "html"
