---
title: 'HTML'
description: 'Build extension UIs with plain HTML entrypoints for popups, options, side panels, and devtools. Extension.js handles asset wiring and script bundling.'
icon: 'code'
keywords:
  [
    'extension.js',
