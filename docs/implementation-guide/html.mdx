...
Most user-facing extension surfaces that render UI are HTML entrypoints with different manifest fields and runtime expectations. Pick the surface that matches your interaction model, then keep the HTML page itself thin.
