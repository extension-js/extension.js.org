---
title: "HTML entrypoints for extension UIs"
description: "Build popup, options, sidebar, new-tab, and devtools pages with HTML entrypoints while Extension.js handles asset wiring and script/style bundling."
icon: "html"
keywords: ["extension.js", "chrome", "browser", "manifest", "hmr", "side panel", "popup", "devtools"]
---
...
- Persist settings and state with [Storage](/implementation-guide/storage).
- Coordinate UI pages with [Messaging](/implementation-guide/messaging).
- Learn more about [special folders](/features/special-folders).
- Continue with [CSS in development](/implementation-guide/css).
