---
title: "HTML entrypoints in extensions"
description: "Build extension UIs with plain HTML entrypoints while Extension.js handles asset wiring, script and style bundling, and dev-time updates."
icon: "html"
