...
![sidebar template screenshot](https://raw.githubusercontent.com/extension-js/examples/main/public/sidebar/screenshot.png)
...
| DevTools page    | `devtools_page`                                             | debugging or inspection tools for developers       |
