---
title: "Extension storage APIs"
description: "Use browser storage APIs including storage.local, storage.sync, storage.session, and storage.managed with service-worker-friendly patterns and code examples."
icon: "puzzle"
