---
title: 'Storage'
description: 'Persist settings and runtime state with chrome.storage APIs. Covers local, sync, and session areas plus cross-browser behavior and migration patterns.'
icon: 'puzzle'
keywords:
  [
    'extension.js',
