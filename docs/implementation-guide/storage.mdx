...
Extension.js does not replace or wrap browser storage APIs — it only compiles your code that calls them. The choice of storage area still matters though, because it shapes service-worker reliability, cross-browser consistency, and future data-structure changes.
