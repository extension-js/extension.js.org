---
title: "Storage"
description: "Choose the right browser storage area for your extension using storage.local, storage.sync, storage.session, and storage.managed with MV3 patterns."
icon: "puzzle"
