...
Extension.js does not replace or wrap browser storage APIs — it only compiles your code that calls them. The choice of storage area still matters. It shapes service-worker reliability, cross-browser consistency, and how easily you can change your data structure later.
