...
Extension.js supports plain CSS plus Sass and Less preprocessors out of the box. It routes styles differently for page contexts (popup, options, side panel) and content-script contexts. Page styles ship as linked assets. Content-script styles are injected into the host document so they apply in your tab.
