---
title: "CSS"
description: "Style extension pages and content scripts with plain CSS, Sass, Less, CSS Modules, and PostCSS through context-aware output routing and HMR support."
icon: "css"
