---
title: "CSS styling in extensions"
description: "Style extension pages and content scripts with plain CSS, Sass, or LESS preprocessors using context-specific output and automatic reload behavior."
icon: "css"
keywords: ["extension.js", "manifest", "hmr", "postcss", "content script", "popup", "docs", "implementation guide"]
---
...
- Learn more about [PostCSS integration](/integrations/postcss).
