---
title: 'CSS'
description: 'Style extension pages and content scripts with plain CSS, Sass, or Less. Extension.js routes styles by context and applies HMR during development.'
icon: 'palette'
keywords:
  [
    'extension.js',
