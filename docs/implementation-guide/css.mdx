---
title: "CSS in browser extensions"
description: "Style extension pages and content scripts with plain CSS, Sass, or Less while Extension.js handles context-specific output and reload behavior."
icon: "css"
