...
description: "Author content scripts with the mount-style default export contract, HMR support, MAIN world isolation, and multi-entry patterns for Extension.js."
icon: "file-code"
