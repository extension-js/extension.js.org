...
description: 'Build page-integrated features with content scripts in Extension.js. Learn how JS and CSS entries compile, mount at runtime, and support HMR during dev.'
icon: 'file-code'
keywords:
  [
    'extension.js',
