...
description: 'Build page-integrated extension features with content scripts. Extension.js compiles manifest entries, wraps them for hot module replacement (HMR), and emits predictable outputs.'
icon: 'file-code'
keywords:
  [
    'extension.js',
...
Extension.js compiles content script entries from `manifest.json`, wraps them for runtime mounting and hot module replacement (HMR) behavior, and emits predictable `content_scripts/*` outputs.
