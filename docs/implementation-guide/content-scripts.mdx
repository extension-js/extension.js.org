...
description: "Build content scripts with Extension.js covering manifest-driven entries, dev remount flow, MAIN vs isolated world support, and predictable output layout."
icon: "file-code"
keywords: ["extension.js", "chrome", "firefox", "browser", "manifest", "javascript", "react", "hmr"]
---
...
Use [browser-specific prefixes](/features/browser-specific-fields) to declare MAIN world only for Chromium and provide an isolated fallback for Firefox:
...
- Understand update outcomes in [dev update behavior](/workflows/dev-update-behavior).
- Design cross-context communication with [Messaging](/implementation-guide/messaging).
- Review access scope in [Permissions and host permissions](/implementation-guide/permissions-and-host-permissions).
- Learn about [web-accessible resources](/implementation-guide/web-accessible-resources).
- Continue with [locales in development](/implementation-guide/locales).
