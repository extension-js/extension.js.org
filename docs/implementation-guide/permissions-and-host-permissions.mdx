...
Extension.js compiles and validates your extension. The browser still enforces `permissions`, `host_permissions`, and `optional_*` fields from `manifest.json`. Good permission design improves user trust and reduces review friction.
