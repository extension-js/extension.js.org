...
description: "Design minimal permission scopes using permissions, host_permissions, and optional variants with a feature-type mapping table and review checklist."
icon: "puzzle"
