...
description: 'Declare only the permissions your extension needs. Learn best practices for permissions, host_permissions, and optional fields to improve user trust.'
icon: 'puzzle'
keywords:
  [
    'extension.js',
