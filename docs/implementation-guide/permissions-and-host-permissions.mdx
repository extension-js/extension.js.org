...
description: "Design extension permissions, host permissions, and optional permissions in manifest.json to balance capability with user trust and review speed."
icon: "puzzle"
