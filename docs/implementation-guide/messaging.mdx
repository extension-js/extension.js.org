...
Extension.js bundles background scripts, content scripts, and extension pages together. Those contexts still communicate through browser-extension messaging APIs. Good messaging structure keeps your privilege boundaries clear and makes debugging easier.
