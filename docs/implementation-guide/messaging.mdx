---
title: "Messaging"
description: "Send messages between popup, content scripts, and background service workers using runtime.sendMessage, tabs.sendMessage, and runtime.connect patterns."
icon: "puzzle"
