...
description: "Send data between popup, content scripts, and background service workers using browser extension messaging APIs with clear privilege boundaries."
icon: "puzzle"
