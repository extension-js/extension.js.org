...
description: 'Move data across extension contexts with browser messaging APIs. Keep privilege boundaries clear between background, content scripts, and extension pages.'
icon: 'puzzle'
keywords:
  [
    'extension.js',
...
Extension.js bundles background scripts, content scripts, and extension pages together. Those contexts still communicate through browser-extension messaging APIs. Good messaging structure keeps your privilege boundaries clear and makes debugging more reliable.
