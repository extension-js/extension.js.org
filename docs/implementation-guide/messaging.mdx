...
Extension.js bundles background scripts, content scripts, and extension pages together. Those contexts still communicate through browser-extension messaging APIs. Good messaging structure keeps each context's responsibilities clear and makes debugging more reliable.
