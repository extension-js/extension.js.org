---
title: "Extension messaging APIs"
description: "Move data between popup, content scripts, and background service workers with runtime.sendMessage, typed protocols, and sender validation patterns."
icon: "puzzle"
keywords: ["extension.js", "chrome", "browser", "content script", "service worker", "popup", "docs", "implementation guide"]
---
...
- Persist data with [Storage](/implementation-guide/storage).
- Design event-driven logic in [Background scripts / service worker](/implementation-guide/background).
- Review boundary safety in [Security checklist](/workflows/security-checklist).
