---
title: 'Locales'
description: 'Ship localized extension metadata and UI strings with _locales handling. Extension.js discovers, validates, and emits locale JSON in dev and production builds.'
icon: 'language'
keywords:
  [
    'extension.js',
