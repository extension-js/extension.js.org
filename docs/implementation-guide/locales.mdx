...
description: "Ship localized extension metadata and UI strings with predictable _locales handling in both Extension.js development and production builds."
icon: "locale"
