...
description: "Ship localized extension metadata and UI strings with _locales handling, including locale discovery, validation, build output mapping, and dev watch support."
icon: "locale"
keywords: ["extension.js", "manifest", "hmr", "docs", "implementation guide", "locales", "template", "example"]
---
...
- Continue with [JSON in development](/implementation-guide/json).
- Learn about [manifest development behavior](/implementation-guide/manifest-json).
