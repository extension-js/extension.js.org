---
title: "Locales"
description: "Ship localized extension metadata and UI strings with _locales handling, default_locale validation, __MSG__ reference checks, and dev watch support."
icon: "locale"
