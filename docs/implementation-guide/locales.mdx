---
title: 'Locales'
description: 'Ship localized extension metadata and UI strings with _locales handling. Extension.js validates locale files, emits assets, and watches for updates.'
icon: 'language'
keywords:
  [
    'extension.js',
