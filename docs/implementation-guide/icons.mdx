---
title: "Icons"
description: "Declare extension icons in manifest fields for actions, sidebar, and browser action with PNG, JPG, and SVG support and automatic path resolution."
icon: "icons"
