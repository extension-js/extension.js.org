---
title: "Extension icons in manifest.json"
description: "Declare toolbar and extension icons in manifest.json fields that Extension.js validates, rewrites to output paths, and watches during development."
icon: "icons"
keywords: ["extension.js", "browser", "manifest", "docs", "implementation guide", "icons", "template", "example"]
---
...
- Continue with [web-accessible resources](/implementation-guide/web-accessible-resources).
