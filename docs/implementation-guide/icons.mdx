---
title: 'Icons'
description: 'Declare extension icons in manifest.json and let Extension.js validate, resolve, and emit them. Covers action icons, toolbar icons, and theme variants.'
icon: 'icons'
keywords:
  [
    'extension.js',
