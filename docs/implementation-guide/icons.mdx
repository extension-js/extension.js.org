...
description: "Declare and manage extension icons across manifest fields like action.default_icon and icons with automatic validation, path resolution, and dev watch."
icon: "icons"
