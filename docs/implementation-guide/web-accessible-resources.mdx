...
description: "Expose only the extension assets that web pages need by declaring web_accessible_resources and letting Extension.js handle manifest normalization."
icon: "puzzle"
