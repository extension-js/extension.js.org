...
description: 'Expose only the extension assets web pages need. Extension.js merges user-declared web_accessible_resources with build-discovered files per browser target.'
icon: 'puzzle'
keywords:
  [
    'extension.js',
