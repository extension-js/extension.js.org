...
description: "Learn how Extension.js handles web_accessible_resources by merging user-declared entries with build-discovered assets and normalizing MV2/MV3 schemas."
icon: "puzzle"
keywords: ["extension.js", "chrome", "firefox", "browser", "manifest", "hmr", "content script", "docs"]
---
...
- Continue with [commands reference](/commands/dev).
