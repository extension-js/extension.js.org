...
description: "Learn how Extension.js merges user-declared web_accessible_resources with build-discovered assets for MV2 and MV3, including security best practices."
icon: "puzzle"
