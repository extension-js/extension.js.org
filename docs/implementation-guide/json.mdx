...
description: "Use JSON resources like declarativeNetRequest rulesets and managed schemas with validation and predictable output handling in Extension.js."
icon: "brackets-curly"
