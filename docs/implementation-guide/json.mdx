---
title: "JSON"
description: "Handle manifest-referenced JSON resources like declarative_net_request rulesets and managed_schema files with validation and placeholder replacement."
icon: "brackets-curly"
