---
title: 'JSON'
description: 'Use JSON resources for declarativeNetRequest rulesets, managed schemas, and other manifest-referenced features with validation and watch-mode support.'
icon: 'brackets-curly'
keywords:
  [
    'extension.js',
