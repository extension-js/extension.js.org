...
description: "Process manifest-referenced JSON resources like declarative net request rulesets and managed storage schemas with validation and dev tracking support."
icon: "brackets-curly"
keywords: ["extension.js", "browser", "manifest", "docs", "implementation guide", "json", "capabilities", "support"]
---
...
- Continue with [icons in development](/implementation-guide/icons).
