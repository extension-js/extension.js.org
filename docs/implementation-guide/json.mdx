...
description: 'Use JSON resources like declarative net request rulesets and managed schemas in extensions. Extension.js validates and emits referenced JSON assets correctly.'
icon: 'brackets-curly'
keywords:
  [
    'extension.js',
...
Extension.js replaces `$EXTENSION_*` placeholders in emitted `.json` assets during compilation, similar to how it replaces placeholders in HTML files.
