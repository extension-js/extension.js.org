---
title: "Scripts"
description: "Compile JS and TypeScript entrypoints for background, content scripts, and UI pages through the SWC pipeline with HMR and context-aware reload behavior."
icon: "js"
