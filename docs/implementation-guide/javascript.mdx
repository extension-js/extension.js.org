---
title: 'Scripts'
description: 'Ship JavaScript and TypeScript across background, content scripts, and UI pages with the Extension.js SWC-based compilation pipeline and HMR support.'
icon: 'code'
keywords:
  [
    'extension.js',
