---
title: "JavaScript and TypeScript scripts"
description: "Learn how Extension.js collects and compiles JS/TS entrypoints from manifest.json, HTML pages, and special folders using the default SWC-based pipeline."
icon: "js"
keywords: ["extension.js", "browser", "manifest", "typescript", "javascript", "hmr", "content script", "service worker"]
---
...
- Learn how to structure files with [special folders](/features/special-folders).
- Continue with [background scripts and service workers](/implementation-guide/background).
