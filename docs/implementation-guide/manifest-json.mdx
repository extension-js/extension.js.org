---
title: "Manifest.json compilation"
description: "Learn how Extension.js treats manifest.json as the source of truth, performing browser-specific field filtering, path normalization, and per-target output."
icon: "brackets-curly"
keywords: ["extension.js", "chrome", "firefox", "edge", "browser", "manifest", "hmr", "content script"]
---
...
For permission strategy, see [Permissions and host permissions](/implementation-guide/permissions-and-host-permissions).
...
- Design least-privilege access in [Permissions and host permissions](/implementation-guide/permissions-and-host-permissions).
- Learn how Extension.js handles [browser-specific fields](/features/browser-specific-fields).
- Understand dev update flow in [page reload and HMR](/features/reload-and-hmr).
