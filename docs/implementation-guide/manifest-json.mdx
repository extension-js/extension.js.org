...
When a project has a `package.json`, Extension.js ignores `public/manifest.json`. This guard prevents a copied static asset from overwriting the generated manifest.
