---
title: 'Manifest'
description: 'Treat manifest.json as the source of truth for entrypoints and assets. Extension.js compiles, filters browser fields, rewrites paths, and validates files.'
icon: 'brackets-curly'
keywords:
  [
    'extension.js',
