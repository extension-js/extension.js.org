...
description: 'Use manifest.json as the source of truth for entrypoints and assets. Extension.js compiles, rewrites paths, and emits a browser-ready manifest per target.'
icon: 'brackets-curly'
keywords:
  [
    'extension.js',
