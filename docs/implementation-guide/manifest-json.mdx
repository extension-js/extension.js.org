...
When a project has a `package.json`, Extension.js ignores `public/manifest.json`. This prevents a copied static asset from overwriting the manifest that Extension.js generates.
