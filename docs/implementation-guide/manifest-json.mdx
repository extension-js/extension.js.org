...
description: 'Use manifest.json as the source of truth for entrypoints and assets. Extension.js compiles, rewrites paths, and emits a browser-ready manifest.'
icon: 'brackets-curly'
keywords:
  [
    'extension.js',
