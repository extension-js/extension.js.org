---
title: "Manifest"
description: "Understand how Extension.js reads manifest.json as the source of truth, compiles browser-prefixed keys, normalizes paths, and validates referenced files."
icon: "brackets-curly"
