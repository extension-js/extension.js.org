---
title: "ESLint integration for Extension.js"
description: "Enforce consistent code quality in your browser extension project with ESLint, including flat config support and CI-friendly lint workflows."
icon: "shield-check"
keywords: ["browser", "typescript", "javascript", "react", "eslint", "prettier", "stylelint", "docs"]
---
...
- Integrate [Prettier](/integrations/prettier) to avoid formatting-rule conflicts.
- Add [Stylelint](/integrations/stylelint) for stylesheet linting.
