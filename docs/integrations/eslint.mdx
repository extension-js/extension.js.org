...
description: "Add ESLint to Extension.js projects for code quality checks with flat config support, CI-friendly execution, and extension-specific rulesets."
icon: "shield-check"
