---
title: "ESLint"
description: "Set up ESLint with flat config for JS and TypeScript linting in extension projects, including a starter template and pre-commit hook best practices."
icon: "shield-check"
