---
title: "ESLint integration for code quality"
description: "Keep extension code quality consistent with ESLint. Runs outside the Extension.js build pipeline through your scripts or CI for predictable results."
keywords:
  [
    "browser",
    "typescript",
