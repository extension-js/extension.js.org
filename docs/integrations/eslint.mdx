...
description: 'Keep extension code quality consistent with ESLint. Runs outside the Extension.js build pipeline through your scripts or CI for predictable linting results.'
icon: 'shield-check'
keywords:
  [
    'browser',
...
Keep extension code quality predictable before issues reach runtime. ESLint runs outside the build pipeline. Run it from your scripts or CI.
