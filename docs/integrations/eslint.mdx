---
title: 'ESLint'
description: 'Lint browser extension code with ESLint alongside Extension.js. Set up configs, extension-specific rules, and CI integration for consistent code quality.'
icon: 'shield-check'
keywords:
  [
    'browser',
