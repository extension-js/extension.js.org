---
title: "Babel integration for Extension.js"
description: "Add Babel transforms and plugins alongside the default SWC pipeline in Extension.js when you need Babel-only presets or incremental migration."
icon: "tower-broadcast"
keywords: ["extension.js", "rspack", "eslint", "docs", "integrations", "babel", "good", "fit"]
---
...
- Keep code quality high with [ESLint](/integrations/eslint).
