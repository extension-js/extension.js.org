---
title: "Babel"
description: "Add Babel alongside the default SWC pipeline for targeted transforms like MDX or legacy migration by scoping it to specific file types in extension.config."
