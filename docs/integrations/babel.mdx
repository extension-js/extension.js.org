---
title: 'Babel'
description: 'Add Babel to an Extension.js project only when SWC cannot cover your transform needs. Scope Babel to specific files and keep SWC as the default pipeline.'
