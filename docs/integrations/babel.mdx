...
description: "Add Babel selectively for transforms or plugins not covered by SWC, scoped to specific file types through the extension.config.js configuration hook."
