...
description: 'Build extension UI with accessible, composable shadcn/ui components in a Tailwind-enabled React setup. Reuse design primitives across popup and options pages.'
icon: 'palette'
keywords:
  [
    'extension.js',
