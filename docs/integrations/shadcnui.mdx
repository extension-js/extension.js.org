...
Build extension UI with accessible, composable components using the same shadcn/ui workflow used in web apps. Use this when your team wants reusable design primitives instead of custom ad-hoc UI per surface.
