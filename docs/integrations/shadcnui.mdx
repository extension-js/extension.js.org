...
description: "Use shadcn/ui accessible React components in Extension.js projects with source-owned primitives reusable across sidebar, popup, and options surfaces."
icon: "palette"
