---
title: "Shadcn/ui"
description: "Use shadcn/ui accessible React components in browser extensions with Tailwind CSS, including the sidebar-shadcn template and content script setup."
icon: "palette"
