...
shadcn/ui works inside an extension the same way it works in a web app if your project uses a Tailwind-enabled React setup. Components live in your source tree (not `node_modules`), so you keep full control over styling and behavior per surface.
