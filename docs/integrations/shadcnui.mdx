...
If you need stronger isolation for content scripts, mount your UI inside a Shadow DOM root (a browser-native encapsulation boundary) and scope your class names intentionally.
