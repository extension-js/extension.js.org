---
title: 'Shadcn/ui'
description: 'Build extension popup, options, and side panel UIs with shadcn/ui components. Set up Tailwind, React, and the shadcn CLI inside an Extension.js project.'
icon: 'palette'
keywords:
  [
    'extension.js',
