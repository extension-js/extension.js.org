---
title: "Shadcn/ui in Extension.js projects"
description: "Build accessible, composable extension UI with shadcn/ui components in popup, options, sidebar, and new-tab surfaces using Extension.js and React."
icon: "palette"
keywords: ["extension.js", "typescript", "react", "tailwindcss", "postcss", "eslint", "prettier", "content script"]
---
...
1. Set up Tailwind and PostCSS (see [Tailwind CSS](/integrations/tailwindcss)).
...
- Set up [Tailwind CSS](/integrations/tailwindcss) if you have not already.
- Add linting and formatting with [ESLint](/integrations/eslint) and [Prettier](/integrations/prettier).
