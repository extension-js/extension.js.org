---
title: 'Stylelint'
description: 'Catch CSS issues early across extension surfaces with Stylelint. Run it from scripts or CI alongside Extension.js for consistent stylesheet quality checks.'
icon: 'paint-roller'
keywords:
  [
    'extension.js',
