...
description: "Integrate Stylelint for consistent stylesheet quality checks across extension surfaces, running through scripts and CI outside the Extension.js build pipeline."
icon: "paint-roller"
