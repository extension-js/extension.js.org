...
description: 'Catch CSS issues early and keep stylesheet quality consistent across extension surfaces. Stylelint runs through scripts or CI alongside Extension.js builds.'
icon: 'paint-roller'
keywords:
  [
    'extension.js',
