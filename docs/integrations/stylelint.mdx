---
title: "Stylelint integration for Extension.js"
description: "Lint and enforce stylesheet quality across extension popup, options, sidebar, and content script surfaces using Stylelint with Extension.js projects."
icon: "paint-roller"
keywords: ["extension.js", "postcss", "prettier", "stylelint", "docs", "integrations", "good", "fit"]
---
...
- Learn how to integrate [Prettier](/integrations/prettier) into your formatting workflow.
- Configure [PostCSS](/integrations/postcss) for stylesheet transforms.
