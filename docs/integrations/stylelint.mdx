---
title: "Stylelint"
description: "Add Stylelint for CSS, Sass, and Less quality checks in browser extension projects, run via scripts or CI alongside Prettier and ESLint integration."
icon: "paint-roller"
