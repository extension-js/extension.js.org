...
description: "Add Tailwind CSS v3 or v4 to Extension.js projects for utility-first styling across popup, options, sidebar, new-tab, and content-script surfaces."
icon: "wind"
