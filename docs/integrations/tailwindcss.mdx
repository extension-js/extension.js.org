---
title: "Tailwind CSS"
description: "Set up Tailwind CSS v3 or v4 with Extension.js for popup, options, sidebar, and content-script surfaces using PostCSS integration and starter templates."
icon: "wind"
