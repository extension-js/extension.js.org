---
title: 'Tailwind CSS'
description: 'Style extension popups, options pages, and content scripts with Tailwind CSS utility classes. Extension.js supports both Tailwind v3 and v4 via PostCSS.'
icon: 'wind'
keywords:
  [
    'extension.js',
