---
title: 'Tailwind CSS for extension styling'
description: 'Style extension popups, options pages, sidebars, and content scripts with Tailwind utility classes. Supports both Tailwind v3 and v4 via PostCSS integration.'
icon: 'wind'
keywords:
  [
    'extension.js',
