---
title: "Tailwind CSS in Extension.js projects"
description: "Style extension popup, options, sidebar, new-tab, and content script surfaces with Tailwind CSS utility classes in your Extension.js project."
icon: "wind"
keywords: ["extension.js", "tailwindcss", "postcss", "stylelint", "content script", "popup", "docs", "integrations"]
---
...
- Configure [PostCSS](/integrations/postcss) for additional CSS transforms.
- Ensure your CSS follows best practices with [Stylelint](/integrations/stylelint).
