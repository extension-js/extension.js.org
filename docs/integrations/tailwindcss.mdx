...
description: 'Style extension popups, options pages, sidebars, and content scripts with Tailwind CSS utility classes. Supports Tailwind v3 and v4 via PostCSS.'
icon: 'wind'
keywords:
  [
    'extension.js',
