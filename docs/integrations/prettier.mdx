---
title: 'Prettier'
description: 'Keep formatting consistent across your extension codebase with Prettier. Configure it for editor integration, scripts, and CI alongside Extension.js builds.'
