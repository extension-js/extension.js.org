...
description: 'Keep formatting consistent across your extension codebase with Prettier. Runs from scripts, editor plugins, and CI outside the Extension.js pipeline.'
