---
title: 'Prettier'
description: 'Keep formatting consistent across your extension codebase with Prettier. Runs from scripts, editor integration, and CI outside the Extension.js build pipeline.'
