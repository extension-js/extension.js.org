---
title: "Prettier"
description: "Configure Prettier for deterministic code formatting in extension projects with ESLint integration via eslint-config-prettier and a starter template."
