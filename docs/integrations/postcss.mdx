---
title: "PostCSS"
description: "Transform CSS across extension pages and content scripts with PostCSS plugins like Autoprefixer, auto-detected from your postcss.config configuration."
icon: "droplet"
