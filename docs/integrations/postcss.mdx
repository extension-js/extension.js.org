...
description: 'Transform CSS across browser extension pages and content scripts with PostCSS plugins like Autoprefixer. Extension.js detects your config and configures the loader.'
icon: 'droplet'
keywords:
  [
