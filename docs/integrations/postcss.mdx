...
description: 'Transform CSS across extension pages and content scripts with PostCSS plugins like Autoprefixer. Extension.js detects your config and applies postcss-loader.'
icon: 'droplet'
keywords:
  [
    'extension.js',
...
Extension.js applies PostCSS in both contexts but packages the output differently — using the CSS pipeline for pages and the asset pipeline for content scripts.
