...
description: "Transform CSS with PostCSS plugins like Autoprefixer and Tailwind across extension pages and content scripts using the Extension.js build pipeline."
icon: "droplet"
