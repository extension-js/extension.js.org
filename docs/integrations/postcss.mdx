...
description: 'Transform CSS across extension pages and content scripts with PostCSS plugins like Autoprefixer. Extension.js detects your config and wires the loader.'
icon: 'droplet'
keywords:
  [
    'extension.js',
