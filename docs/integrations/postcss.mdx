---
title: "PostCSS in browser extensions"
description: "Transform CSS across extension pages and content scripts with PostCSS plugins like Autoprefixer. Extension.js auto-detects your config and loader setup."
keywords:
  [
...
```bash bun
bun add -d postcss postcss-loader autoprefixer
```

```bash deno
deno add -D npm:postcss npm:postcss-loader npm:autoprefixer
```
