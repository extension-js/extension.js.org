...
description: 'Use pages/, scripts/, and public/ folders for entrypoints and assets that do not fit in manifest.json. Extension.js discovers and compiles them automatically.'
icon: 'folder-open'
keywords:
  [
    'extension.js',
