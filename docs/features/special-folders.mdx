...
The manifest does not directly declare many extension files. These include iframe pages, scripts you inject dynamically with `chrome.scripting.executeScript`, static vendor assets, and companion extensions used during development. Special folders make these first-class in the build pipeline.
