...
The manifest does not directly declare many extension files: iframe pages, scripts injected with `scripting.executeScript`, static vendor assets, and companion extensions for development. Special folders make these first-class in the build pipeline.
