...
You do not declare many extension files directly in the manifest: iframe pages, scripts injected with `scripting.executeScript`, static vendor assets, and companion extensions used in development. Special folders make these first-class in the build pipeline.
...
- Learn more about [Reload and Hot-Module Replacement](/docs/features/reload-and-hmr).
