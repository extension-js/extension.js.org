...
The manifest does not directly declare many extension files: iframe pages, scripts you inject with `scripting.executeScript`, static vendor assets, and companion extensions you use in development. Special folders make these first-class in the build pipeline.
