...
description: "Use pages/, scripts/, public/, and _locales/ folders for extra entrypoints and assets that do not fit in manifest.json, including companion extensions."
icon: "folder-open"
keywords: ["extension.js", "extensions", "chrome", "firefox", "manifest", "react", "hmr", "content script"]
---
...
- Learn more about [reload and hot-module replacement](/features/reload-and-hmr).
- Understand the mount contract in [Content scripts](/implementation-guide/content-scripts).
