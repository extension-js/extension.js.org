...
The manifest does not directly declare many extension files, such as iframe pages, dynamically injected scripts, static vendor assets, and companion extensions for development. Special folders make these first-class in the build pipeline.
