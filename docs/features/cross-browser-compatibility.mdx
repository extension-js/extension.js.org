...
Extension.js handles browser-specific setup during development and build. Produce runtime-correct outputs for Chromium and Gecko (Firefox engine) targets from one project.
