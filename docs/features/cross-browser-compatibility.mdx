...
description: "Target Chrome, Firefox, and Edge from one codebase with browser-specific manifest filtering, per-target output folders, and optional polyfill support."
