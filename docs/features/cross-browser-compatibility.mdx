...
description: "Produce runtime-correct extension outputs for Chrome, Firefox, and Edge from a single manifest.json with automatic field filtering and polyfills."
keywords: ["extension.js", "extensions", "chrome", "firefox", "edge", "browser", "manifest", "popup"]
---
...
During compilation, Extension.js includes only manifest fields for the selected browser.
...
> Note: Browser-prefixed manifest fields are covered in detail in [browser-specific manifest fields](/features/browser-specific-fields).
...
- Learn more about [browser-specific manifest fields](/features/browser-specific-fields).
