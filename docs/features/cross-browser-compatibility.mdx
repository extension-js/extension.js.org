...
During compilation, Extension.js includes only the manifest fields for the selected browser.
...
For Firefox, Extension.js skips this step because `browser.*` is already built in.
