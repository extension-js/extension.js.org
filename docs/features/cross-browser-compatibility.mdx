...
description: 'Build one extension that runs on Chrome, Firefox, and Edge. Learn how Extension.js normalizes manifests, polyfills APIs, and handles browser differences.'
keywords:
  [
    'extension.js',
    'extensions',
