...
can produce runtime-correct outputs for Chromium and Gecko (Firefox engine) targets from one
project.
...
<Note>Browser-prefixed manifest fields are covered in detail in [Browser-specific manifest fields](/docs/features/browser-specific-fields).</Note>
