...
description: 'Explore core Extension.js capabilities including cross-browser builds, manifest config, HMR reload behavior, path resolution, and privacy-safe telemetry.'
icon: 'puzzle'
keywords:
  [
    'extension.js',
