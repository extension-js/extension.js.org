...
description: 'Build and package the same extension for Chrome, Edge, and Firefox in one pass. Extension.js writes per-browser output and optional zip distribution files.'
icon: 'box'
keywords:
  [
    'extension.js',
