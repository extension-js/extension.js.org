...
description: "Configure browser-specific .env files, built-in variables like EXTENSION_PUBLIC_BROWSER, and the EXTENSION_PUBLIC_ prefix convention for bundle injection."
icon: "key"
keywords: ["extension.js", "extensions", "chrome", "firefox", "edge", "browser", "manifest", "typescript"]
---
...
- Review browser targeting in [browsers available](/browsers/browsers-available).
- Configure shared defaults in [`extension.config.js`](/features/extension-configuration).
