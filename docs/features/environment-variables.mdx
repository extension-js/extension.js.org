...
description: 'Manage API keys, feature flags, and browser-specific values with .env files. Extension.js loads variables for both compiled bundles and config files.'
icon: 'key'
keywords:
  [
    'extension.js',
