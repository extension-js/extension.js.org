...
description: "Load environment variables from .env files into extension bundles with EXTENSION_PUBLIC_ prefixes, browser/mode awareness, and monorepo support."
icon: "key"
