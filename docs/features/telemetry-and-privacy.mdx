...
description: "Review the Extension.js telemetry contract covering what anonymous CLI data is collected, what is never collected, and how to opt out with --no-telemetry."
icon: "puzzle"
