...
description: "Review what anonymous CLI and build data Extension.js collects, what it never collects like source code or secrets, and how to opt out with --no-telemetry."
icon: "puzzle"
...
- Are you only experimenting locally, or are you repeatedly producing release artifacts?
