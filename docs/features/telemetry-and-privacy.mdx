...
description: 'Review the Extension.js telemetry contract covering anonymous CLI analytics, what data is never collected, and how to opt out of telemetry entirely.'
icon: 'puzzle'
keywords:
  [
    'extension.js',
