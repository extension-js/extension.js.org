...
Extension.js collects minimal anonymous telemetry to understand which commands you run and which fail. Extension.js never collects source code, file paths, URLs, or project content.
