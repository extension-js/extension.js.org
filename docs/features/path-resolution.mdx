...
description: "Write asset paths naturally and let Extension.js normalize them to runtime-safe output paths across manifest fields and extension API calls."
icon: "route"
