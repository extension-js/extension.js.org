...
description: "Write file paths naturally and let Extension.js normalize them to runtime-safe output paths across manifest fields and extension API calls."
icon: "route"
keywords: ["extension.js", "chrome", "firefox", "browser", "manifest", "javascript", "popup", "devtools"]
---
...
- Learn more about [special folders](/features/special-folders).
- Learn more about [web accessible resources](/implementation-guide/web-accessible-resources).
