...
description: 'Write paths naturally and let Extension.js normalize them to runtime-safe output. Manifest fields and extension API references resolve correctly per browser.'
icon: 'route'
keywords:
  [
    'extension.js',
