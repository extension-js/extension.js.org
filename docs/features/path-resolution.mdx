...
Not every manifest field rewrites to a folder with the same source name. Extension.js bases output paths on the browser-facing extension contract, not on your original authoring path.
