...
description: "Learn how Extension.js normalizes authored paths in manifest fields and JS/TS source to runtime-safe output paths across all extension contexts."
icon: "route"
