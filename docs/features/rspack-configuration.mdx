...
Solve custom bundler needs (loaders, plugins, aliases) without forking the default setup. Extension.js builds with Rspack, a fast Rust-based bundler compatible with webpack (`@rspack/core`), and lets you extend the generated config directly.
