---
title: "Rspack bundler configuration"
description: "Customize Rspack loaders, plugins, and aliases in the Extension.js build pipeline through the config key in your extension.config.js file."
icon: "puzzle"
