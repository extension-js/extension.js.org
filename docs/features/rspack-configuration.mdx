...
description: 'Customize Rspack loaders, plugins, and aliases without forking the default Extension.js build setup. Extend bundler config through extension.config.js.'
icon: 'puzzle'
keywords:
  [
    'extension.js',
