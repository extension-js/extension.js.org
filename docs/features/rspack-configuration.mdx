---
title: "Rspack configuration via extension.config.js"
description: "Customize the Rspack bundler through a function hook or object merge in extension.config.js for loaders, plugins, and advanced build behavior."
icon: "puzzle"
keywords: ["extension.js", "browser", "rspack", "docs", "features", "rspack configuration", "configuration", "via"]
---
...
- Learn more about [Extension Config (`extension.config.js`)](/features/extension-configuration).
- Learn more about [Multi-Platform Builds](/features/multi-platform-builds).
