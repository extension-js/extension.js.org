...
description: "Customize Rspack bundling behavior via extension.config.js using function hooks or object merging to add loaders, plugins, and resolve aliases."
icon: "puzzle"
