...
Solve custom bundler needs (loaders, plugins, aliases) without forking the default setup. Extension.js builds with Rspack, a Rust-based JavaScript bundler (`@rspack/core`). You can extend the generated config directly.
