...
> Note: The `/pages` and `/scripts` folders are special folders recognized by Extension.js for hot-reloading. Extension.js treats each entry in these folders as a separate page or script and reloads it independently.
