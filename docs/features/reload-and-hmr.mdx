...
<Note>Extension.js recognizes the `/pages` and `/scripts` folders for hot-reloading and treats each entry as a separate page or script it can reload independently.</Note>
