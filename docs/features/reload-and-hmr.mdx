...
description: "Understand how Extension.js picks between HMR, hard extension reload, and full restart for each file change during development to keep feedback fast."
icon: "gauge-high"
