---
title: "Page reload and HMR in Extension.js"
description: "Understand when Extension.js applies HMR, hard reloads, or restart-required diagnostics during development based on the type of file change."
icon: "gauge-high"
