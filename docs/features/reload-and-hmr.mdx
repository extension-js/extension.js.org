...
description: 'Understand how Extension.js picks the fastest safe update path during development, including HMR for styles, hard reloads, and restart-required changes.'
icon: 'gauge-high'
keywords:
  [
    'extension.js',
