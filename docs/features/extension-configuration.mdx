...
- In monorepos, if Extension.js finds no project-local `.env*` file, it falls back to the nearest workspace root (directory containing `pnpm-workspace.yaml`) and applies the same order there.
