...
description: 'Set browser defaults, command behavior, and Rspack bundler customization in one config file shared across your Extension.js project and team.'
icon: 'puzzle'
keywords:
  [
    'extension.js',
