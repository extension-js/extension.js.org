---
title: "Extension configuration file"
description: "Centralize browser defaults, command options, and bundler settings in extension.config.js so your team avoids repeating CLI flags."
icon: "puzzle"
