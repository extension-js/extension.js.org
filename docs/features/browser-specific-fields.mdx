...
- Chromium-family targets (`chrome`, `edge`, `chromium-based`, and the forks `brave`, `opera`, `vivaldi`, `yandex`) resolve: `chromium:`, `chrome:`, `edge:`
...
| `edge:`     | `edge`, `chromium-based`, and other Chromium-family targets                             |
| `firefox:`  | `firefox`, `gecko-based`, `firefox-based`, `waterfox`, `librewolf`                      |
| `gecko:`    | `firefox`, `gecko-based`, `firefox-based`, `waterfox`, `librewolf`                      |

An exact browser-name prefix (for example, `brave:`, `vivaldi:`, or `waterfox:`) resolves only when you target that same browser.
