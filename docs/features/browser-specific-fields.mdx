...
description: 'Define Chrome-only and Firefox-only manifest values inline with prefixes. Extension.js emits only the fields that match each browser target at build time.'
keywords:
  [
    'extension.js',
    'extensions',
