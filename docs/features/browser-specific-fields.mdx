...
description: "Define browser-specific manifest values inline with prefixes so Extension.js emits only the fields matching Chrome, Edge, or Firefox at build time."
