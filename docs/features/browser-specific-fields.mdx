...
description: "Use inline browser-prefixed keys like chromium:, chrome:, edge:, and firefox: in one manifest.json so Extension.js emits only matching fields per target."
...
- Learn more about [Cross-Browser Compatibility](/features/cross-browser-compatibility).
