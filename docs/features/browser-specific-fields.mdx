...
description: "Use chromium:, firefox:, and other browser-prefixed keys in one manifest.json to emit browser-correct output at compile time without separate files."
