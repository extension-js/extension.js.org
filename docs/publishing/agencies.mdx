...
On the direct track, a `.env.submit` file you write yourself is the per-client
credential file: one per repository, kept out of git, backed by your own secret
storage.
