...
description: "Drive a live extension dev session from the terminal: read logs, inspect the DOM, eval in the worker, read chrome.storage, and reload on Chrome or Firefox."
keywords:
  [
