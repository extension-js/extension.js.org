...
{/* VIDEO_PLACEHOLDER: Show three edits in sequence (component change, manifest metadata change, entrypoint list change) and the resulting HMR/hard-reload/restart-required behavior. */}
![Video placeholder: update mode outcomes](https://placehold.co/960x540?text=Video+placeholder)
