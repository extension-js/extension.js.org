...
{/* VIDEO_PLACEHOLDER: Show a pre-release security pass that trims permissions and narrows web_accessible_resources before packaging. */}
![Video placeholder: extension security review pass](https://placehold.co/960x540?text=Video+placeholder)
