...
{/* VIDEO_PLACEHOLDER: Show a pull request CI run executing lint, multi-browser build, and Playwright checks with uploaded failure artifacts. */}
![Video placeholder: CI pipeline validation flow](https://placehold.co/960x540?text=Video+placeholder)
