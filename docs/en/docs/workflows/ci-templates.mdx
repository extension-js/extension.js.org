...
For slow or resource-constrained containers, increase browser transport timeouts via environment variables (see [browser transport tuning variables](../features/environment-variables.mdx#browser-transport-tuning-variables)).
