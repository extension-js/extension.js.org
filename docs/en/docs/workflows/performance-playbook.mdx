...
{/* VIDEO_DEMO_SOON: Show profiling a slow extension startup, applying focused optimizations, and validating improved runtime behavior. */}
![Video demo soon: extension performance optimization flow](https://placehold.co/960x540?text=Video+demo+soon)
