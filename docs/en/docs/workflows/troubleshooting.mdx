...
{/* VIDEO_DEMO_SOON: Show a failing dev run, identify the error class, apply one fix, and rerun successfully. */}
![Video demo soon: troubleshooting triage flow](https://placehold.co/960x540?text=Video+demo+soon)
