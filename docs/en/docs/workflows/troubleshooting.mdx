...
- If browser connections are slow or flaky in CI/containers, increase the transport timeouts via [browser transport tuning variables](../features/environment-variables.mdx#browser-transport-tuning-variables).
