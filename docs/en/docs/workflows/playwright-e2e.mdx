...
{/* VIDEO_PLACEHOLDER: Show running one Playwright E2E test that opens the extension UI, validates behavior, and captures trace on failure. */}
![Video placeholder: Playwright E2E extension flow](https://placehold.co/960x540?text=Video+placeholder)
