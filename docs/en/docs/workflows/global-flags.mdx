...
{/* VIDEO_PLACEHOLDER: Show running the same command with and without `--no-telemetry` and `--ai-help --format=json` to compare output behavior. */}
![Video placeholder: global flags behavior](https://placehold.co/960x540?text=Video+placeholder)
