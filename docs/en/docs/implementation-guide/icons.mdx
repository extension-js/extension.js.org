...
{/* VIDEO_PLACEHOLDER: Show replacing manifest icon files and verifying updated assets in extension UI surfaces across build output. */}
![Video placeholder: icon declaration and output flow](https://placehold.co/960x540?text=Video+placeholder)
