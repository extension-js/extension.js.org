...
{/* VIDEO_DEMO_SOON: Show adding a new locale key, updating manifest `__MSG_*__` usage, and validating locale output across builds. */}
![Video demo soon: locale workflow and validation](https://placehold.co/960x540?text=Video+demo+soon)
