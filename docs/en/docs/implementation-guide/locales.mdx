...
<PackageManagerTabs
  command={{
    npm: 'npx extension@latest create my-extension --template=action-locales',
    pnpm: 'pnpx extension@latest create my-extension --template=action-locales',
    yarn: 'yarn dlx extension@latest create my-extension --template=action-locales'
  }}
/>
