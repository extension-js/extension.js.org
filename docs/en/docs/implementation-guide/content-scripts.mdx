...
{/* VIDEO_PLACEHOLDER: Show isolated-world and MAIN-world content script behavior differences, plus live update flow for JS and CSS changes. */}
![Video placeholder: content script runtime and update flow](https://placehold.co/960x540?text=Video+placeholder)
