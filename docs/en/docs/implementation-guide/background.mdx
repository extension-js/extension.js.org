...
{/* VIDEO_PLACEHOLDER: Show background service worker edit flow, including hard reload behavior and restart-required when background entry structure changes. */}
![Video placeholder: background script dev behavior](https://placehold.co/960x540?text=Video+placeholder)
