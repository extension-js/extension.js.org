...
<PackageManagerTabs
  command={{
    npm: 'npx extension@latest create my-extension --template=action',
    pnpm: 'pnpx extension@latest create my-extension --template=action',
    yarn: 'yarn dlx extension@latest create my-extension --template=action'
  }}
/>
...
<PackageManagerTabs
  command={{
    npm: 'npx extension@latest create my-extension --template=action-chatgpt',
    pnpm: 'pnpx extension@latest create my-extension --template=action-chatgpt',
    yarn: 'yarn dlx extension@latest create my-extension --template=action-chatgpt'
  }}
/>
...
- Persist durable runtime state with [Storage](./storage.mdx).
- Coordinate contexts with [Messaging](./messaging.mdx).
