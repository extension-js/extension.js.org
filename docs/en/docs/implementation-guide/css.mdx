...
<PackageManagerTabs
  command={{
    npm: 'npx extension@latest create my-extension --template=content-sass',
    pnpm: 'pnpx extension@latest create my-extension --template=content-sass',
    yarn: 'yarn dlx extension@latest create my-extension --template=content-sass'
  }}
/>
...
<PackageManagerTabs
  command={{
    npm: 'npx extension@latest create my-extension --template=content-custom-font',
    pnpm: 'pnpx extension@latest create my-extension --template=content-custom-font',
    yarn: 'yarn dlx extension@latest create my-extension --template=content-custom-font'
  }}
/>
