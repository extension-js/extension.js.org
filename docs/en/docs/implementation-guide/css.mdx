...
{/* VIDEO_PLACEHOLDER: Show CSS changes in a popup page and a content script, highlighting different output/update behavior for each context. */}
![Video placeholder: CSS behavior by extension context](https://placehold.co/960x540?text=Video+placeholder)
