...
{/* VIDEO_DEMO_SOON: Show one feature script reused across popup, content script, and background contexts with target-safe compiled output. */}
![Video demo soon: JavaScript pipeline across extension contexts](https://placehold.co/960x540?text=Video+demo+soon)
