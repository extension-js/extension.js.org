...
<PackageManagerTabs
  command={{
    npm: 'npx extension@latest create my-extension --template=javascript',
    pnpm: 'pnpx extension@latest create my-extension --template=javascript',
    yarn: 'yarn dlx extension@latest create my-extension --template=javascript'
  }}
/>
