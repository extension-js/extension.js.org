...
- Keep one manifest accurate in [manifest.json](./manifest-json.mdx).
- Review page access in [Web accessible resources](./web-accessible-resources.mdx).
- Validate boundary handling in [Messaging](./messaging.mdx).
- Do a release pass with [Security checklist](../workflows/security-checklist.mdx).
