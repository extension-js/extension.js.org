...
{/* VIDEO_DEMO_SOON: Show tightening WAR from broad to minimal resource/match patterns and validating runtime access still works. */}
![Video demo soon: web accessible resources hardening flow](https://placehold.co/960x540?text=Video+demo+soon)
