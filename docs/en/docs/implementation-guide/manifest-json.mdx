...
For permission strategy, see [Permissions and host permissions](./permissions-and-host-permissions.mdx).
...
- Design least-privilege access in [Permissions and host permissions](./permissions-and-host-permissions.mdx).
