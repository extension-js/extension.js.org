...
{/* VIDEO_PLACEHOLDER: Show editing one manifest file, running different browser targets, and inspecting target-specific emitted manifest output. */}
![Video placeholder: manifest compile and target filtering](https://placehold.co/960x540?text=Video+placeholder)
