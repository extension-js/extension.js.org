...
<PackageManagerTabs
  command={{
    npm: 'npx extension@latest create my-extension --template=sidebar',
    pnpm: 'pnpx extension@latest create my-extension --template=sidebar',
    yarn: 'yarn dlx extension@latest create my-extension --template=sidebar'
  }}
/>
...
- Persist settings and state with [Storage](./storage.mdx).
- Coordinate UI pages with [Messaging](./messaging.mdx).
