...
{/* VIDEO_DEMO_SOON: Show an HTML entrypoint importing a script and stylesheet, then inspect emitted compiled HTML and bundled assets. */}
![Video demo soon: HTML entrypoint processing](https://placehold.co/960x540?text=Video+demo+soon)
