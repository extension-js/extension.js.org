...
- Persist data with [Storage](./storage.mdx).
- Design event-driven logic in [Background scripts / service worker](./background.mdx).
- Review boundary safety in [Security checklist](../workflows/security-checklist.mdx).
