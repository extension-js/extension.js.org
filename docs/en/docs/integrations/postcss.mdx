...
{/* VIDEO_PLACEHOLDER: Show one CSS file processed by PostCSS for both a popup page and a content script entry. */}
![Video placeholder: PostCSS in pages and content scripts](https://placehold.co/960x540?text=Video+placeholder)
