...
{/* VIDEO_PLACEHOLDER: Show style lint failures on CSS files, then fix and rerun Stylelint. */}
![Video placeholder: Stylelint workflow](https://placehold.co/960x540?text=Video+placeholder)
