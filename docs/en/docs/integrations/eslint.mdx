...
{/* VIDEO_PLACEHOLDER: Show lint errors in an extension project, then fix and rerun ESLint successfully. */}
![Video placeholder: ESLint workflow](https://placehold.co/960x540?text=Video+placeholder)
