...
{/* VIDEO_PLACEHOLDER: Show enabling Babel for MDX only while keeping SWC for JS/TS in the same extension build. */}
![Video placeholder: targeted Babel integration](https://placehold.co/960x540?text=Video+placeholder)
