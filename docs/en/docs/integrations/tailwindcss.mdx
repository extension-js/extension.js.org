...
{/* VIDEO_PLACEHOLDER: Show Tailwind classes rendering in a sidebar page and then in a content script entry. */}
![Video placeholder: Tailwind across extension surfaces](https://placehold.co/960x540?text=Video+placeholder)
