...
{/* VIDEO_DEMO_SOON: Show generating a shadcn component and using it in a sidebar extension UI. */}
![Video demo soon: shadcn component workflow](https://placehold.co/960x540?text=Video+demo+soon)
