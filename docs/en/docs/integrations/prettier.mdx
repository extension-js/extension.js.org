...
{/* VIDEO_PLACEHOLDER: Show formatting drift in files, then run Prettier to normalize output. */}
![Video placeholder: Prettier formatting workflow](https://placehold.co/960x540?text=Video+placeholder)
