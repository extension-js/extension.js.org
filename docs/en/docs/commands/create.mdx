...
<PackageManagerTabs
  command={{
    npm: 'npx extension@latest create my-extension --template=init --install=false',
    pnpm: 'pnpx extension@latest create my-extension --template=init --install=false',
    yarn: 'yarn dlx extension@latest create my-extension --template=init --install=false'
  }}
/>
