...
{/* VIDEO_DEMO_SOON: Show creating a new extension from template, installing dependencies, and opening the generated project structure. */}
![Video demo soon: create command scaffold flow](https://placehold.co/960x540?text=Video+demo+soon)
