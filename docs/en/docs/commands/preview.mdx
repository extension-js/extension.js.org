...
{/* VIDEO_PLACEHOLDER: Show previewing an existing `dist/<browser>` output after build and validating runtime behavior manually. */}
![Video placeholder: preview command local artifact flow](https://placehold.co/960x540?text=Video+placeholder)
...
{/* VIDEO_PLACEHOLDER: Show previewing one built artifact across two explicit browser targets for release checks. */}
![Video placeholder: preview multi-browser validation](https://placehold.co/960x540?text=Video+placeholder)
...
{/* VIDEO_PLACEHOLDER: Show preview with `--no-runner` for CI/local verification when browser launch is not needed. */}
![Video placeholder: preview no-runner flow](https://placehold.co/960x540?text=Video+placeholder)
