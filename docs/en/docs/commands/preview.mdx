...
{/* VIDEO_DEMO_SOON: Show preview with `--no-browser` for CI/local verification when browser launch is not needed. */}
![Video demo soon: preview no-browser flow](https://placehold.co/960x540?text=Video+demo+soon)
