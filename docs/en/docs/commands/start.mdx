...
{/* VIDEO_DEMO_SOON: Show `start` building production output and launching the extension in the default browser target. */}
![Video demo soon: start command default flow](https://placehold.co/960x540?text=Video+demo+soon)
...
{/* VIDEO_DEMO_SOON: Show `start --no-browser` generating production output without launching a browser session. */}
![Video demo soon: start no-browser flow](https://placehold.co/960x540?text=Video+demo+soon)
