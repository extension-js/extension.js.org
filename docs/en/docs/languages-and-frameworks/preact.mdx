...
{/* VIDEO_DEMO_SOON: Show Preact template setup, runtime launch, and UI update cycle with refresh behavior. */}
![Video demo soon: preact extension workflow](https://placehold.co/960x540?text=Video+demo+soon)
