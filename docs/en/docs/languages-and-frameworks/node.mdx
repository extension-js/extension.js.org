...
<PackageManagerTabs
  command={{
    npm: 'npx extension@latest create my-extension --template=new-crypto',
    pnpm: 'pnpx extension@latest create my-extension --template=new-crypto',
    yarn: 'yarn dlx extension@latest create my-extension --template=new-crypto'
  }}
/>
