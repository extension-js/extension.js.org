...
<PackageManagerTabs
  command={{
    npm: 'npx extension@latest create my-extension --template=new-react-router',
    pnpm: 'pnpx extension@latest create my-extension --template=new-react-router',
    yarn: 'yarn dlx extension@latest create my-extension --template=new-react-router'
  }}
/>
