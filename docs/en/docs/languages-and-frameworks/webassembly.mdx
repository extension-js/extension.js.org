...
<PackageManagerTabs
  command={{
    npm: 'npx extension@latest create my-extension --template=sidebar-transformers-js',
    pnpm: 'pnpx extension@latest create my-extension --template=sidebar-transformers-js',
    yarn: 'yarn dlx extension@latest create my-extension --template=sidebar-transformers-js'
  }}
/>
