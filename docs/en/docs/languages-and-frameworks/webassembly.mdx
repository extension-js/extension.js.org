...
{/* VIDEO_PLACEHOLDER: Show running a wasm sample extension, loading it in the browser, and verifying wasm-powered behavior. */}
![Video placeholder: webassembly extension runtime flow](https://placehold.co/960x540?text=Video+placeholder)
