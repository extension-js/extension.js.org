...
- Review [Global flags](../workflows/global-flags.mdx) for `--no-telemetry`.
- Use [Build](../commands/build.mdx) and [Dev](../commands/dev.mdx) for release and automation workflows.
