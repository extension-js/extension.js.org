...
{/* VIDEO_DEMO_SOON: Show creating `extension.config.js` and running `extension dev` with defaults applied automatically. */}
![Video demo soon: extension config basics](https://placehold.co/960x540?text=Video+demo+soon)
...
{/* VIDEO_DEMO_SOON: Show switching browser targets with config defaults and optional custom browser binary. */}
![Video demo soon: browser defaults by target](https://placehold.co/960x540?text=Video+demo+soon)
...
{/* VIDEO_DEMO_SOON: Show `dev` and `build` using different command defaults from one config file. */}
![Video demo soon: command-level defaults](https://placehold.co/960x540?text=Video+demo+soon)
...
{/* VIDEO_DEMO_SOON: Show extending generated bundler config with a custom rule and validating build output. */}
![Video demo soon: bundler config override](https://placehold.co/960x540?text=Video+demo+soon)
