...
<PackageManagerTabs
  command={{
    npm: 'npx extension@latest create my-extension --template=new-env',
    pnpm: 'pnpx extension@latest create my-extension --template=new-env',
    yarn: 'yarn dlx extension@latest create my-extension --template=new-env'
  }}
/>
...
<PackageManagerTabs
  command={{
    npm: 'npx extension@latest create my-extension --template=content-env',
    pnpm: 'pnpx extension@latest create my-extension --template=content-env',
    yarn: 'yarn dlx extension@latest create my-extension --template=content-env'
  }}
/>
