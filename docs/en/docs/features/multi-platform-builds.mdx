...
{/* VIDEO_DEMO_SOON: Show a default production build and where output appears under `dist/`. */}
![Video demo soon: default multi-platform build](https://placehold.co/960x540?text=Video+demo+soon)
...
{/* VIDEO_DEMO_SOON: Show one command building `chrome`, `edge`, and `firefox` with separate outputs. */}
![Video demo soon: browser matrix build flow](https://placehold.co/960x540?text=Video+demo+soon)
...
{/* VIDEO_DEMO_SOON: Show final `dist/<browser>` folder layout after a matrix build. */}
![Video demo soon: output layout by browser](https://placehold.co/960x540?text=Video+demo+soon)
...
{/* VIDEO_DEMO_SOON: Show zip output generation with default and custom `--zip-filename` values. */}
![Video demo soon: zip packaging workflow](https://placehold.co/960x540?text=Video+demo+soon)
...
{/* VIDEO_DEMO_SOON: Show source archive generation and where `-source.zip` is written. */}
![Video demo soon: source archive output](https://placehold.co/960x540?text=Video+demo+soon)
...
{/* VIDEO_DEMO_SOON: Show `--polyfill` build output for Chromium target when using `browser.*` in code. */}
![Video demo soon: polyfill build behavior](https://placehold.co/960x540?text=Video+demo+soon)
