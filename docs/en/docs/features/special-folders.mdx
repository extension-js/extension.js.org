...
<PackageManagerTabs
  command={{
    npm: 'npx extension@latest create my-extension --template=special-folders-pages',
    pnpm: 'pnpx extension@latest create my-extension --template=special-folders-pages',
    yarn: 'yarn dlx extension@latest create my-extension --template=special-folders-pages'
  }}
/>
...
<PackageManagerTabs
  command={{
    npm: 'npx extension@latest create my-extension --template=special-folders-scripts',
    pnpm: 'pnpx extension@latest create my-extension --template=special-folders-scripts',
    yarn: 'yarn dlx extension@latest create my-extension --template=special-folders-scripts'
  }}
/>
...
- Understand the mount contract in [Content scripts](../implementation-guide/content-scripts.mdx).
