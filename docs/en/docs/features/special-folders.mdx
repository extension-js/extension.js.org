...
{/* VIDEO_PLACEHOLDER: Show a page added under `pages/` and then loaded in the running extension build. */}
![Video placeholder: pages folder workflow](https://placehold.co/960x540?text=Video+placeholder)
...
{/* VIDEO_PLACEHOLDER: Show a script added under `scripts/` and injected at runtime with `scripting.executeScript`. */}
![Video placeholder: scripts folder workflow](https://placehold.co/960x540?text=Video+placeholder)
...
{/* VIDEO_PLACEHOLDER: Show a static file in `public/` copied directly to `dist/` with unchanged path. */}
![Video placeholder: public folder workflow](https://placehold.co/960x540?text=Video+placeholder)
...
{/* VIDEO_PLACEHOLDER: Show a companion extension inside `extensions/` loading together with the main extension in dev mode. */}
![Video placeholder: extensions folder workflow](https://placehold.co/960x540?text=Video+placeholder)
