...
{/* VIDEO_DEMO_SOON: Show adding a custom loader in `config` and seeing it applied during development build. */}
![Video demo soon: function hook customization](https://placehold.co/960x540?text=Video+demo+soon)
...
{/* VIDEO_DEMO_SOON: Show object merge adding a resolve alias and importing through the alias in extension code. */}
![Video demo soon: object merge customization](https://placehold.co/960x540?text=Video+demo+soon)
...
{/* VIDEO_DEMO_SOON: Show a Rspack-native plugin (DefinePlugin) injecting a compile-time flag. */}
![Video demo soon: rspack plugin usage](https://placehold.co/960x540?text=Video+demo+soon)
