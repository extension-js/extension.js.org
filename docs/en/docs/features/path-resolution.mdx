...
{/* VIDEO_PLACEHOLDER: Show the same authored path resolving correctly after build for Chrome and Firefox outputs. */}
![Video placeholder: path normalization flow](https://placehold.co/960x540?text=Video+placeholder)
...
{/* VIDEO_PLACEHOLDER: Show a manifest with source-style paths and the emitted manifest with normalized output paths. */}
![Video placeholder: manifest path rewrite example](https://placehold.co/960x540?text=Video+placeholder)
...
{/* VIDEO_PLACEHOLDER: Show `runtime.getURL('/icons/icon.png')` resolving to packaged output at runtime. */}
![Video placeholder: runtime getURL path resolution](https://placehold.co/960x540?text=Video+placeholder)
