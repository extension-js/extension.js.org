...
{/* VIDEO_PLACEHOLDER: Show a small JS/CSS change applied instantly through HMR without full extension reload. */}
![Video placeholder: hmr update flow](https://placehold.co/960x540?text=Video+placeholder)
...
{/* VIDEO_PLACEHOLDER: Show a manifest or locale change triggering full extension reload during development. */}
![Video placeholder: hard reload trigger flow](https://placehold.co/960x540?text=Video+placeholder)
...
{/* VIDEO_PLACEHOLDER: Show a file-entry change that triggers restart-required guidance in dev output. */}
![Video placeholder: restart required diagnostics](https://placehold.co/960x540?text=Video+placeholder)
...
{/* VIDEO_PLACEHOLDER: Show `pages/` and `scripts/` updates using HMR vs restart-required behavior. */}
![Video placeholder: off-manifest reload behavior](https://placehold.co/960x540?text=Video+placeholder)
