...
{/* VIDEO_PLACEHOLDER: Show one prefixed manifest being compiled for Chrome and Firefox, then compare generated outputs. */}
![Video placeholder: resolving browser-prefixed manifest fields](https://placehold.co/960x540?text=Video+placeholder)
...
{/* VIDEO_PLACEHOLDER: Show adding vendor-specific `chrome:` and `edge:` fields and validating the generated target manifest. */}
![Video placeholder: vendor-specific manifest variants](https://placehold.co/960x540?text=Video+placeholder)
