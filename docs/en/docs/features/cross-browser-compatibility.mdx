...
{/* VIDEO_PLACEHOLDER: Show switching targets with `--browser` and with a custom Chromium binary. */}
![Video placeholder: selecting a browser target](https://placehold.co/960x540?text=Video+placeholder)
...
{/* VIDEO_PLACEHOLDER: Show one manifest with prefixed fields being compiled for Chrome vs Firefox. */}
![Video placeholder: manifest filtering by target](https://placehold.co/960x540?text=Video+placeholder)
...
{/* VIDEO_PLACEHOLDER: Show build output folders changing by target in `dist/<browser>`. */}
![Video placeholder: browser-specific build output](https://placehold.co/960x540?text=Video+placeholder)
...
{/* VIDEO_PLACEHOLDER: Show a `browser.*` API working in Chromium with `--polyfill` enabled. */}
![Video placeholder: polyfill flow on Chromium](https://placehold.co/960x540?text=Video+placeholder)
