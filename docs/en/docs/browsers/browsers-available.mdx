...
{/* VIDEO_PLACEHOLDER: Show switching the same extension run between `chrome`, `edge`, and `firefox` with `--browser`. */}
![Video placeholder: named browser targets](https://placehold.co/960x540?text=Video+placeholder)
...
{/* VIDEO_PLACEHOLDER: Show using custom Chromium and Gecko binaries with engine-based browser targets. */}
![Video placeholder: engine-based target binaries](https://placehold.co/960x540?text=Video+placeholder)
...
{/* VIDEO_PLACEHOLDER: Show sequential multi-browser run using comma-separated browser targets. */}
![Video placeholder: multi-browser selection flow](https://placehold.co/960x540?text=Video+placeholder)
