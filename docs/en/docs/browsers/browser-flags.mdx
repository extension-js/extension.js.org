...
{/* VIDEO_PLACEHOLDER: Show browser-level flags plus command-level overrides and the final launch flags used at runtime. */}
![Video placeholder: browser flag merge precedence](https://placehold.co/960x540?text=Video+placeholder)
...
{/* VIDEO_PLACEHOLDER: Show Chromium and Firefox launches using different flag behavior from the same config. */}
![Video placeholder: chromium vs firefox flag behavior](https://placehold.co/960x540?text=Video+placeholder)
...
{/* VIDEO_PLACEHOLDER: Show engine-based target launch with custom browser binary and target-specific flags. */}
![Video placeholder: engine target flags with custom binaries](https://placehold.co/960x540?text=Video+placeholder)
