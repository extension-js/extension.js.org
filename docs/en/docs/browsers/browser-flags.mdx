...
<PackageManagerTabs
  command={{
    npm: 'npx extension@latest create my-extension --template=new-browser-flags',
    pnpm: 'pnpx extension@latest create my-extension --template=new-browser-flags',
    yarn: 'yarn dlx extension@latest create my-extension --template=new-browser-flags'
  }}
/>
