...
{/* VIDEO_PLACEHOLDER: Show default browser preferences in config, then command-level override taking precedence in a dev run. */}
![Video placeholder: preference precedence flow](https://placehold.co/960x540?text=Video+placeholder)
...
{/* VIDEO_PLACEHOLDER: Show Firefox preferences written to `user.js` in managed profile and applied on launch. */}
![Video placeholder: firefox user.js preference flow](https://placehold.co/960x540?text=Video+placeholder)
...
{/* VIDEO_PLACEHOLDER: Show Chromium behavior tuned with flags/profile instead of Firefox-style preference file. */}
![Video placeholder: chromium preference alternatives](https://placehold.co/960x540?text=Video+placeholder)
