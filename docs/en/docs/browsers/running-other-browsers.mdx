...
{/* VIDEO_DEMO_SOON: Show launching the same extension in Brave and Firefox Developer Edition using binary flags. */}
![Video demo soon: custom browser binary launch](https://placehold.co/960x540?text=Video+demo+soon)
...
{/* VIDEO_DEMO_SOON: Show config-based binary defaults applied automatically in `dev` and `preview`. */}
![Video demo soon: config-driven binary defaults](https://placehold.co/960x540?text=Video+demo+soon)
...
{/* VIDEO_DEMO_SOON: Show invalid binary path error handling and then successful launch after fixing the path. */}
![Video demo soon: binary path validation flow](https://placehold.co/960x540?text=Video+demo+soon)
