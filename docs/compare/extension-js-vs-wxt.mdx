...
<CardGroup cols={2}>
  <Card title="Choose Extension.js if…">
    ...
    - You want Rspack's Rust-speed builds and docs that your assistant can read: a docs MCP endpoint and `llms.txt` ([details](/docs/ai-access)).
  </Card>
...
| AI surfaces          | Docs MCP endpoint + `llms.txt` ([details](/docs/ai-access))                | `llms.txt` available                                                |
