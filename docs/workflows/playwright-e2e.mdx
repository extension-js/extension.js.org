...
In other words, `--no-browser` produces build output. The wait step confirms readiness before tests proceed. If your environment cannot run a second CLI process, you can fall back to directly polling `ready.json`.
