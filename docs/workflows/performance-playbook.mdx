...
description: "Keep extension startup fast and runtime overhead low across content scripts, service workers, and UI surfaces with this optimization playbook."
icon: "puzzle"
keywords: ["browser", "playwright", "content script", "service worker", "popup", "docs", "workflows", "performance playbook"]
---
...
- Review [Playwright E2E](/workflows/playwright-e2e).
