...
Performance regressions in your extension come from a short list of places: service worker cold-starts (initial startup delays), heavy content-script injection, oversized UI bundles, and media-heavy web-accessible resources.
