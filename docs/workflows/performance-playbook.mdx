...
Performance regressions in your extension tend to come from a short list of places: service worker cold-starts, heavy work at content-script injection time, oversized UI bundles, and media-heavy web-accessible resources. The checklists below map each regression type to a concrete fix.
