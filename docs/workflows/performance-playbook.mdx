...
description: 'Keep extension startup fast and runtime overhead low. Optimize content scripts, service workers, and UI surfaces as your Extension.js project features grow.'
icon: 'puzzle'
keywords:
  [
    'browser',
