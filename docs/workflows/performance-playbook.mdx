...
description: "Optimize extension startup and runtime performance across content scripts, service workers, and popup UIs with actionable tips and CI performance checks."
icon: "puzzle"
