...
description: "Keep extension startup fast and runtime overhead low across content scripts, service workers, and UI surfaces with practical optimization rules."
icon: "puzzle"
