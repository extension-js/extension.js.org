...
Build an adblocker, also written ad blocker or content blocker, with the `declarativeNetRequest` API. You declare matching rules, and the browser blocks requests natively before they leave the network stack.
