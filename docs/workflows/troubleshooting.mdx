...
- If browser connections are slow or flaky in CI/containers, increase the transport timeouts via [browser transport tuning variables](/docs/features/environment-variables#browser-transport-tuning-variables).
