...
- If browser connections are slow or flaky in CI containers, increase the connection timeouts. See [browser transport tuning variables](/docs/features/environment-variables#browser-transport-tuning-variables) for details.
