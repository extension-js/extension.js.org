...
description: 'Fix common Extension.js issues fast with a structured triage flow. Covers restart diagnostics, dependency setup, browser launch, and manifest path errors.'
icon: 'puzzle'
keywords:
