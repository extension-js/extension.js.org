...
description: "Fix common Extension.js issues including missing dependencies, browser binary errors, build failures, manifest path problems, and Docker networking."
icon: "puzzle"
