...
description: "Diagnose and fix common Extension.js failures including browser launch issues, manifest errors, HMR problems, and dependency setup with a triage guide."
icon: "puzzle"
