...
description: 'Reduce extension attack surface before release with a repeatable review checklist. Covers least privilege, constrained runtime access, and input handling.'
icon: 'puzzle'
keywords:
  [
    'browser',
