...
Extensions tend to fail store audits and internal reviews for a few recurring reasons. Permissions drift wider than features need. Content scripts trust page context. Web accessible resources (WAR) expose internals to arbitrary origins. Message handlers act on unverified senders. Run this checklist before every release cut.
