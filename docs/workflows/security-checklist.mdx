...
Your extension can fail store audits and internal reviews for a few recurring reasons: permissions drift wider than your features need, content scripts trust page context unsafely, web-accessible resources (WAR) expose internals to arbitrary origins, and message handlers act on unverified senders.
