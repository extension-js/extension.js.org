...
description: "Reduce your browser extension attack surface before release with a repeatable checklist covering permissions, CSP, input handling, and storage."
icon: "puzzle"
keywords: ["browser", "manifest", "content script", "docs", "workflows", "security checklist", "security", "checklist"]
---
...
- Review [web-accessible resources](/implementation-guide/web-accessible-resources).
- Review [troubleshooting](/workflows/troubleshooting).
