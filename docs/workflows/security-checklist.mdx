...
| Message boundaries    | You validate privileged actions and check senders |
...
- Default to isolated world (the sandboxed execution context) unless MAIN world (the page's own execution context) is strictly required.
