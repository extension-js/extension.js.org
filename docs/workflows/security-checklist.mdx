...
Extensions fail store audits and internal reviews for a few recurring reasons. Permissions drift wider than your features need. Content scripts trust page context unsafely. Web-accessible resources (WAR) expose internals to arbitrary origins. Message handlers act on unverified senders.
