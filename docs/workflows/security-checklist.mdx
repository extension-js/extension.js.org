...
description: "Review extension permissions, content-script safety, web-accessible resource exposure, and message validation before release with this pre-publish checklist."
icon: "puzzle"
