...
| Keep store paperwork in one file       | [Store metadata (STORE.md)](/docs/workflows/store-metadata)  |
| Ship to Chrome, Firefox, and Edge      | [Publish to the browser stores](/docs/publishing)            |
