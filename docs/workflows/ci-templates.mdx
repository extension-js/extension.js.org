---
title: 'CI templates'
description: 'Automate lint, build, and end-to-end checks for browser extensions with GitHub Actions CI templates. Keep every pull request releasable with Extension.js.'
icon: 'puzzle'
keywords:
  [
    'firefox',
