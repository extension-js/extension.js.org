---
title: "CI templates"
description: "Set up GitHub Actions for extension builds with browser matrix configuration, Playwright integration using readiness gates, and Docker considerations."
icon: "puzzle"
