---
title: "CI pipeline templates"
description: "Automate lint, multi-browser builds, and Playwright E2E checks with ready-to-use GitHub Actions and GitLab CI templates for Extension.js projects."
icon: "puzzle"
