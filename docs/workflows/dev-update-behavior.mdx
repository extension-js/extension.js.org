---
title: 'Dev mode update and reload behavior'
description: 'Know which file changes hot-update and which require a restart during development. Extension.js picks the lightest safe update mode automatically.'
icon: 'puzzle'
keywords:
  [
    'extension.js',
...
- Treat `restart required` diagnostics as authoritative. Continuing without a restart can leave outdated code running in the browser.
