...
description: 'Know which file changes hot-update and which require a restart during development. Extension.js picks the lightest safe update mode per change automatically.'
icon: 'puzzle'
keywords:
  [
    'extension.js',
