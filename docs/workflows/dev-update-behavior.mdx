...
description: "Know which file changes hot-update and which require a restart during development. Extension.js chooses the lightest safe update mode automatically."
keywords:
  [
    "extension.js",
    "browser",
