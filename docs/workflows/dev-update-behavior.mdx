...
description: 'Know which file changes trigger HMR, hard reload, or a full restart during Extension.js development. Keep iteration fast with the right update mode.'
icon: 'puzzle'
keywords:
  [
    'extension.js',
