...
description: "Learn which file changes trigger HMR, hard reloads, or restart-required diagnostics during extension dev so you can iterate faster on your extension."
icon: "puzzle"
