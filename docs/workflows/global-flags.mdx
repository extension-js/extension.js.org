...
description: "Control Extension.js CLI behavior across all commands with global flags for disabling telemetry, enabling AI-oriented help, and machine-readable output."
icon: "puzzle"
