---
title: 'Global flags'
description: 'Control Extension.js CLI behavior consistently across commands with global flags for telemetry opt-out, JSON output, browser selection, and polyfill mode.'
icon: 'puzzle'
keywords:
  [
    'extension.js',
