---
title: "Global flags"
description: "Control cross-command CLI behavior with --no-telemetry to disable analytics, --ai-help for AI-oriented output, and --format for JSON or pretty printing."
icon: "puzzle"
