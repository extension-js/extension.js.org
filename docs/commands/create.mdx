...
description: 'Bootstrap a new browser extension project from an official template with one CLI command. Supports React, Vue, TypeScript, and content-script starters.'
...
<CardGroup cols={2}>
  ...
  >
    Vue UI with SFC support baked in.
  </Card>
</CardGroup>
