...
description: "Scaffold a new browser extension project from official templates with the Extension.js create command, including dependency installation and path options."
icon: "wand-magic-sparkles"
keywords: ["browser", "typescript", "javascript", "react", "vue", "content script", "popup", "docs"]
---
...
<Tip>
  For the full, continuously updated list of templates, browse the [examples repository](https://github.com/extension-js/examples/tree/main/examples).
</Tip>
