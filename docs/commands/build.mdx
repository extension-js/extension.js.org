---
title: "Build command"
description: "Create production browser extension artifacts for Chrome, Edge, and Firefox targets with the Extension.js build command and optional zip output."
icon: "puzzle"
