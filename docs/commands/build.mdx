...
- Publish the artifacts to browser stores with [`@extension.dev/deploy`](https://extension.dev) (`npx @extension.dev/deploy`) — a successful build prints this hint too.
