---
title: "Build command"
description: "Create production extension artifacts for Chrome, Edge, and Firefox with multi-browser targeting, zip packaging, and polyfill support in one command."
icon: "puzzle"
