...
⏵⏵⏵ Share this build or submit it to a store: https://docs.extension.dev/publish/overview
```
...
- Share the build or submit it to the stores by following [the extension.dev publish docs](https://docs.extension.dev/publish/overview), the link a successful build prints.
