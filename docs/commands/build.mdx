---
title: 'Build command'
description: 'Create production-ready extension artifacts for Chrome, Edge, or Firefox targets. Compile, bundle, and optionally zip output with one CLI command.'
icon: 'puzzle'
keywords:
  [
    'extension.js',
