...
Use source options only with `dev`. Source inspection opens a target URL in the browser. It prints the full, live HTML of the page **after** your content scripts run, so you can verify what your extension actually changes.
