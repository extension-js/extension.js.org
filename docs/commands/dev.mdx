...
Use source options only with `dev`. Source inspection opens a target URL in the browser and prints the full, live HTML of the page **after** your content scripts have been injected. This is useful for verifying what your extension actually changes on a page.
