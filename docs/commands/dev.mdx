---
title: 'Dev command'
description: 'Run the Extension.js development server with watch mode, browser launch, and context-aware updates including HMR, hard reload, and restart diagnostics.'
icon: 'puzzle'
keywords:
  [
    'extension.js',
