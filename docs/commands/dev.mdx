...
If you omit the path, Extension.js uses the current working directory. You can also pass a **GitHub tree URL** (for example, `https://github.com/user/repo/tree/main/path`). Extension.js downloads the repository and runs dev mode on the local copy.
