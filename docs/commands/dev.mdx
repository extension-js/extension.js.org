---
title: "Dev command"
description: "Use the dev command for day-to-day extension development with watch mode, HMR, browser launch, source inspection, and context-aware reload behavior."
icon: "puzzle"
