...
description: "Choose the right Extension.js CLI command for each development phase from scaffolding and dev mode to building, previewing, and managing browser runtimes."
icon: "puzzle"
