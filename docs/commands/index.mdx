...
| Point a tab at a url               | `navigate`  | `extension navigate https://example.com/ --new-tab`             |
...
6. `logs`, `inspect`, `eval`, `storage`, `reload`, `open`, and `navigate` to observe and drive the running session.
...
- [navigate](/docs/workflows/driving-the-cli#step-4-act-and-read-envelopes)
