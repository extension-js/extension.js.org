...
description: "Remove managed browser runtimes from the Extension.js cache with the uninstall command, including --all support for clearing every cached browser target."
icon: "puzzle"
