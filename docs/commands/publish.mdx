...
Ask [extension.dev](https://docs.extension.dev) for a shareable URL to a project you already have there.
...
Without either, the command prints `No token.` and exits with code `1` before any network call happens. Create a token from the extension.dev dashboard or the project access-tokens API, documented in [Access tokens](https://docs.extension.dev/tools/access-tokens).
...
- Read how share links behave in [Shared previews](https://docs.extension.dev/share/shared-previews).
- Read how builds are recorded in [Builds](https://docs.extension.dev/builds/overview).
