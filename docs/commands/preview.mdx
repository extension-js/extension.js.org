...
It does not matter whether a build ran in the same command. What matters is whether the chosen folder already contains an unpacked extension with a `manifest.json`.
