...
description: "Launch an already-built extension output for production-like manual testing without recompiling, loading directly from the dist directory for quick QA."
icon: "puzzle"
keywords: ["extensions", "chrome", "firefox", "edge", "browser", "manifest", "hmr", "popup"]
---
...
- Build and launch in one step with [`start`](/commands/start).
- Generate production artifacts with [`build`](/commands/build).
