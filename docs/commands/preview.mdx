...
description: "Launch an already-built extension for production-like manual testing without recompiling, with options for output path and automation metadata."
icon: "puzzle"
