...
description: 'Launch an already-built extension for production-like manual testing. Preview loads unpacked output and runs the browser launcher without recompiling.'
icon: 'puzzle'
keywords:
  [
    'extensions',
