...
description: 'Add a managed browser runtime to the Extension.js cache for deterministic dev, build, and preview runs across Chrome, Firefox, and Edge versions.'
icon: 'puzzle'
keywords:
  [
    'extension.js',
