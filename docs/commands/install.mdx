...
description: "Add managed browser runtimes like Chrome for Testing, Chromium, Firefox, or Edge into the Extension.js cache for deterministic local and CI runs."
icon: "puzzle"
