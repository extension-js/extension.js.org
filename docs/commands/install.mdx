...
description: "Download managed browser runtimes like Chrome for Testing, Chromium, Firefox, and Edge into the Extension.js cache for deterministic local and CI builds."
icon: "puzzle"
keywords: ["extension.js", "chrome", "firefox", "edge", "browser", "docs", "commands", "install"]
---
...
- Remove managed browsers with [`uninstall`](/commands/uninstall).
- Use managed browsers with [`dev`](/commands/dev) and [`start`](/commands/start).
