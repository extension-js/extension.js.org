---
title: "Start command"
description: "Run a production build and immediately launch the extension in a browser with the start command, combining build and preview in one step for local validation."
icon: "puzzle"
keywords: ["extensions", "firefox", "browser", "hmr", "playwright", "popup", "devtools", "docs"]
---
...
- Iterate quickly with [`dev`](/commands/dev).
- Launch existing build output with [`preview`](/commands/preview).
