---
title: 'Start command'
description: 'Run a production build and immediately launch the extension in a browser with one command. Combines the build and preview steps into a single flow.'
icon: 'puzzle'
keywords:
  [
    'extensions',
