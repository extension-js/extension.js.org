---
title: "Start command"
description: "Run a production build and launch the browser in one step with the start command, including CI synchronization via ready.json and Playwright support."
icon: "puzzle"
