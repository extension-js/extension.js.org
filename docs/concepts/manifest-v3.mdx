...
- Event listeners must be registered **synchronously** at the top of the file, not inside async callbacks, or they will not fire on the wake-up event that loaded the worker.
