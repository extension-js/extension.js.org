...
- Starting fresh? Scaffold an MV3-ready project from a [template](/docs/getting-started/templates). React, TypeScript, Svelte, Vue, Preact, and vanilla JavaScript are all covered.
