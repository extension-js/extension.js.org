---
title: "Run custom browsers via binary path"
description: "Launch Brave, Vivaldi, Waterfox, Opera, and other Chromium or Gecko browsers in Extension.js by providing explicit binary paths through CLI or config."
keywords: ["extension.js", "firefox", "browser", "docs", "browsers", "running other browsers", "running", "other"]
---
...
- Check out the [browser preferences](/browsers/browser-preferences) to further configure your environment.
