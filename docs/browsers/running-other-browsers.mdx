...
description: 'Test Brave, Vivaldi, Waterfox, and other Chromium or Gecko browsers by providing explicit binary paths in Extension.js config or CLI flags.'
keywords:
  [
    'extension.js',
    'firefox',
...
- Check out the [browser preferences](/docs/browsers/browser-preferences) to further configure your environment.
