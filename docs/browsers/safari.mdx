...
description: "Build your web extension into a Safari app on macOS with Extension.js. Covers requirements, the build and dev workflow, enabling the extension in Safari, and current limitations."
keywords:
  [
    "extension.js",
    "safari",
