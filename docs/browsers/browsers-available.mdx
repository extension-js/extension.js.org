---
title: "Supported browser targets"
description: "See all browser targets supported by Extension.js including Chrome, Edge, Firefox, Chromium, and engine-based targets for running and testing extensions."
keywords: ["extension.js", "extensions", "chrome", "firefox", "edge", "browser", "manifest", "docs"]
---
...
**Safari** is not a supported `--browser` value in the CLI today. You can still author extensions with shared web code and Safari-specific manifest or build steps outside this workflow; do not assume npm package keywords imply a managed Safari runner comparable to Chrome, Edge, or Firefox.
...
- [Customize browser flags](/browsers/browser-flags).
- [Customize browser preferences](/browsers/browser-preferences).
- [Run other browsers from custom binaries](/browsers/running-other-browsers).
