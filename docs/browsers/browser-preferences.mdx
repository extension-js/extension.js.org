...
`preferences` can still exist in merged config objects, but flags and profile options control Chromium launch behavior, not a Firefox-style `user.js` preference file.
