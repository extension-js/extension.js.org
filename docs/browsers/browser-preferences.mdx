...
`preferences` can still exist in merged config objects. However, flags and profile options control Chromium launch behavior, not a Firefox-style `user.js` preference file.
