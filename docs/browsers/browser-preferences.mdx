...
For a full list of available Firefox preferences, explore the [Firefox source code](https://searchfox.org/mozilla-central/source/) where default preferences are defined in `all.js` or `firefox.js`.
