...
Get repeatable browser behavior during development (for example, homepage defaults, devtools settings, or notification behavior) without changing extension code.
