...
description: "Tune Firefox runtime behavior like homepage, devtools theme, and notifications via extension.config preferences without changing extension source."
