...
description: 'Set Firefox runtime preferences for extension development without changing source code. Configure homepage defaults, devtools, and notification behavior.'
keywords:
  [
    'extension.js',
    'chrome',
