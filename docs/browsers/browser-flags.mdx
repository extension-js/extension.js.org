---
title: "Browser flags"
description: "Pass custom launch flags to Chrome, Edge, or Firefox using browserFlags and excludeBrowserFlags in extension.config for debugging and automation."
