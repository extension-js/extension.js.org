...
Tune browser launch behavior without changing your extension source code. Extension.js merges browser flags from `extension.config.*` and applies them in `dev`, `preview`, and `start` flows.
