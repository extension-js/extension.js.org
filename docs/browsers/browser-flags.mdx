---
title: "Browser launch flags"
description: "Control browser launch flags for debugging, automation, and runtime experiments through extension.config and CLI options with merge precedence support."
keywords: ["extension.js", "chrome", "firefox", "edge", "browser", "devtools", "docs", "browsers"]
---
...
- Learn more about [Browser Preferences](/browsers/browser-preferences).
- Learn more about [Browser Profile](/browsers/browser-profile).
