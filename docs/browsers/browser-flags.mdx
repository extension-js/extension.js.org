---
title: 'Browser flags'
description: 'Control Chrome, Firefox, and Edge launch behavior with browser flags for debugging, automation, and runtime experiments in Extension.js workflows.'
keywords:
  [
    'extension.js',
    'chrome',
