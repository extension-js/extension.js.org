---
title: "Browser flags"
description: "Control browser launch behavior for debugging and automation in Extension.js using flags in extension.config for dev, preview, and start flows."
