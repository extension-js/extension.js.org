---
title: 'Browser launch flags for debugging and automation'
description: 'Control Chrome, Firefox, and Edge launch behavior with browser flags for debugging, automation, and runtime experiments in Extension.js.'
keywords:
  [
    'extension.js',
    'chrome',
...
| `--disable-features=InterestFeedContentSuggestions`     | Disable Discover feed on NTP                             |
...
<Note>
In Docker, CI, or containerized environments Extension.js also adds `--no-sandbox` and `--disable-setuid-sandbox` automatically.
</Note>
