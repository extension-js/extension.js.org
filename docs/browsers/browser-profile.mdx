---
title: "Browser profile management"
description: "Control browser state isolation during Extension.js development with managed ephemeral profiles, persistent profiles, custom paths, and system profile modes."
icon: "user"
keywords: ["extension.js", "chrome", "firefox", "browser", "devtools", "docs", "browsers", "browser profile"]
---
...
- Learn more about [Browser flags](/browsers/browser-flags).
