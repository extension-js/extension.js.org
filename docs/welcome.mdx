...
description: 'Extension.js builds browser extensions for Chrome, Edge, and Firefox with one workflow. Learn how to pick the right command and start building.'
icon: 'puzzle'
keywords:
  [
    'extension.js',
