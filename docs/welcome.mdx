...
description: "Learn what Extension.js does, how to pick the right command for your workflow, and where to start building browser extensions for Chrome, Edge, and Firefox."
icon: "puzzle"
