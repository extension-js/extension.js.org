...
<Note>
  Comparing tools? See how Extension.js stacks up against WXT and other
  frameworks in [Extension.js vs WXT](/docs/compare/extension-js-vs-wxt).
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Compare frameworks" icon="scale-balanced" href="/docs/compare">
    How Extension.js compares to WXT, CRXJS, and Plasmo as a browser extension
    framework.
  </Card>
</CardGroup>
