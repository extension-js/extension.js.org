...
{/* VIDEO_SPEC id=cmd-create pointer — the Loom that sat here duplicated the
  "Extension.js developer workflow" embed above (same id 58e21900…) under a
  different title. Embed the cmd-create take here when recorded; the full beat
  spec lives in docs/commands/create.mdx.
