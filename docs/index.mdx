...
If you already have an extension, install the `extension` package and add commands to your `package.json` scripts once. This keeps local development, testing, and release builds consistent.
