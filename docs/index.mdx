...
<Frame>
  <iframe
    className="w-full aspect-video rounded-xl"
    src="https://www.youtube-nocookie.com/embed/rfGSRJiX39o?autoplay=1&mute=1&loop=1&playlist=rfGSRJiX39o&controls=0&rel=0&playsinline=1"
...
<CardGroup cols={2}>
  ...
  <Card title="Get started immediately" icon="bolt" href="/docs/getting-started/immediately">
    Run a remote sample in one command, no clone or config.
  </Card>
</CardGroup>
