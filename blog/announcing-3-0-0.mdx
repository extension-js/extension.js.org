...
description: "Cross-browser extension workflow with faster builds, Firefox MV3, and first-class TypeScript."
keywords: ["extension.js", "extensions", "chrome", "firefox", "edge", "browser", "typescript", "react"]
---
