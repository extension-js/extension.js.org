---
title: "Announcing Extension.js 3.0.0"
description: "Extension.js 3.0.0 ships faster Rspack-powered builds, Firefox Manifest V3 support, and first-class TypeScript for cross-browser extension development."
keywords:
  [
    "extension.js",
    "extensions",
...
<Note>
  Extension.js 4.0 is the current major release. Read the [4.0
  announcement](/blog/announcing-4-0-0).
</Note>
