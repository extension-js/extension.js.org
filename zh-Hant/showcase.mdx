      ...
      <div className="ext-codepreview-text">
        ...
        <ol className="ext-usedby-steps">
          ...
          <li>
            ...
            <span>在 <code>snippets/used-by.jsx</code> 中新增專案。</span>
          </li>
          <li>
            <span className="ext-usedby-step-num">3</span>
            <span>把圖片放到 <code>images/used-by/</code>。</span>
          </li>
          <li>
        ...
        <p className="ext-usedby-note">專案必須是公開的，且其 <code>package.json</code> 必須將 <code>extension</code> 列為相依套件。專案還必須已在商店上架，並擁有至少 100 名使用者。圖示使用正方形，螢幕截圖可選用。省略某個欄位即可在卡片上隱藏它。每週會有工作檢查每個專案是否仍符合這些要求。</p>
