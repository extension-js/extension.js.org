...
<Frame>
  <iframe
    ...
    src="https://www.youtube-nocookie.com/embed/X6BuVI5q9Rg?rel=0"
    title="Extension.js: one build, three browser targets"
    loading="lazy"
...
這個資料夾一律以你請求的目標命名，即使 `dev` 退而啟動了 Chromium 家族中的另一個二進位檔也一樣。請見[請求的目標 vs. 啟動的二進位檔](/zh-Hant/docs/browsers/browsers-available#requested-target-vs-launch-binary)。
...
- 深入了解 [路徑解析](/zh-Hant/docs/features/path-resolution) 來掌握資產／輸出對應的細節。
