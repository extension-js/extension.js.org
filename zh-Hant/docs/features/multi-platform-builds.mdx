...
<Frame>
  <iframe
    ...
    src="https://www.youtube-nocookie.com/embed/-yz9ATskXIs?autoplay=1&mute=1&loop=1&playlist=-yz9ATskXIs&controls=0&rel=0&playsinline=1"
...
這個資料夾一律以你請求的目標命名，即使 `dev` 退而啟動了 Chromium 家族中的另一個二進位檔也一樣。請見[請求的目標 vs. 啟動的二進位檔](/docs/browsers/browsers-available#requested-target-vs-launch-binary)。
