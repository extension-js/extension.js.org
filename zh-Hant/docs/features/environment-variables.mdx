...
`EXTENSION_TELEMETRY=1` 同時也是 CI 中的明確加入方式：在 CI 裡遙測預設是關閉的。完整的退出條款請參閱 [遙測與隱私](/docs/features/telemetry-and-privacy)。
...
釘選語料庫的運作方式請參閱[範本](/docs/getting-started/templates)。
