...
完整範例(包含把擴充功能 URL 注入 content script)請見 [`web_accessible_resources` 實作](/zh-Hant/docs/implementation-guide/web-accessible-resources)。
...
各 API 的對照請見[權限與主機權限](/zh-Hant/docs/implementation-guide/permissions-and-host-permissions)。
...
- 閱讀[權限與主機權限](/zh-Hant/docs/implementation-guide/permissions-and-host-permissions)。
- 閱讀[背景腳本](/zh-Hant/docs/implementation-guide/background)與[Content scripts](/zh-Hant/docs/implementation-guide/content-scripts)。
- 閱讀 [`web_accessible_resources`](/zh-Hant/docs/implementation-guide/web-accessible-resources)。
- 建置流程請見[跨瀏覽器相容性](/zh-Hant/docs/features/cross-browser-compatibility)。
- 加上前綴的 manifest 鍵請見[瀏覽器專屬的 manifest 欄位](/zh-Hant/docs/features/browser-specific-fields)。
- 建置流程請見[跨瀏覽器相容性](/zh-Hant/docs/features/cross-browser-compatibility)，了解一份 MV3 manifest 如何發布到 Chrome、Firefox 等瀏覽器。
- 從[範本](/zh-Hant/docs/getting-started/templates)建立一個 MV3 就緒的專案：[React](/zh-Hant/docs/getting-started/templates/react)、[TypeScript](/zh-Hant/docs/getting-started/templates/typescript)、[Svelte](/zh-Hant/docs/getting-started/templates/svelte) 等。
- 各[瀏覽器擴充功能框架](/zh-Hant/docs/compare)如何處理 MV3 差異。
