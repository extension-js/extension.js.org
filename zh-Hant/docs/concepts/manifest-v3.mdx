...
- 建置流程請見[跨瀏覽器相容性](/docs/features/cross-browser-compatibility)，了解一份 MV3 manifest 如何發布到 Chrome、Firefox 等瀏覽器。
- 從[範本](/docs/getting-started/templates)建立一個 MV3 就緒的專案：[React](/docs/getting-started/templates/react)、[TypeScript](/docs/getting-started/templates/typescript)、[Svelte](/docs/getting-started/templates/svelte) 等。
