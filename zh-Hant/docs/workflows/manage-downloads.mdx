...
- 在 [錄製螢幕](/zh-Hant/docs/workflows/record-the-screen) 用這個 API 儲存錄製的媒體。
- 在 [安全檢查清單](/zh-Hant/docs/workflows/security-checklist) 稽核 `downloads` 權限。
- 在 [開發更新行為](/zh-Hant/docs/workflows/dev-update-behavior) 檢視 popup 重新載入規則。
