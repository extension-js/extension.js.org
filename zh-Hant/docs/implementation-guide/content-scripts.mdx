...
使用[瀏覽器專屬前綴](/zh-Hant/docs/features/browser-specific-fields)，僅在 Chromium 上宣告 MAIN world，並為 Firefox 提供 isolated 後備：
...
- 透過 [Messaging](/zh-Hant/docs/implementation-guide/messaging) 設計跨情境通訊。
- 在[權限與 host 權限](/zh-Hant/docs/implementation-guide/permissions-and-host-permissions)中檢視存取範圍。
- 了解 [web-accessible resources](/zh-Hant/docs/implementation-guide/web-accessible-resources)。
- 繼續閱讀[開發中的 locale](/zh-Hant/docs/implementation-guide/locales)。
