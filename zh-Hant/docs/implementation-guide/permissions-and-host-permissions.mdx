...
- 在 [manifest.json](/zh-Hant/docs/implementation-guide/manifest-json) 中保持單一 manifest 的正確性。
- 在 [Web-accessible resources](/zh-Hant/docs/implementation-guide/web-accessible-resources) 中檢視頁面存取。
- 在 [Messaging](/zh-Hant/docs/implementation-guide/messaging) 中驗證邊界處理。
- 透過[安全檢查清單](/zh-Hant/docs/workflows/security-checklist)做一次發佈前審視。
