...
- [除錯總覽](/zh-Hant/docs/debugging)：執行中 session 的完整控制介面。
- [可用瀏覽器](/zh-Hant/docs/browsers/browsers-available)：挑一個能載入你的 manifest 的目標。
- [跨瀏覽器相容性](/zh-Hant/docs/features/cross-browser-compatibility)：讓同一份 manifest 在每個引擎上都能運作。
