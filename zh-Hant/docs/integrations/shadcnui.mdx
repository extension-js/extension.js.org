...
1. 設定 Tailwind 與 PostCSS（請參考 [Tailwind CSS](/zh-Hant/docs/integrations/tailwindcss)）。
...
- 若尚未設定，請先設定 [Tailwind CSS](/zh-Hant/docs/integrations/tailwindcss)。
- 透過 [ESLint](/zh-Hant/docs/integrations/eslint) 與 [Prettier](/zh-Hant/docs/integrations/prettier) 加入檢查與格式化。
...
<Frame>
  <iframe
    ...
    src="https://www.youtube-nocookie.com/embed/_Um6LUL5H1o?rel=0"
    title="Extension.js: Sidebar shadcn template"
    loading="lazy"
