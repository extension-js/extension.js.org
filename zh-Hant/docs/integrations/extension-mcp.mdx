...
- 把它與 Google 的 Chrome 除錯 server 一起執行：[Chrome DevTools MCP](/zh-Hant/docs/integrations/chrome-devtools-mcp) 有完整的能力對照表。
- 把文件也接上你的助理：[透過 MCP 與 llms.txt 提供 AI 存取](/zh-Hant/docs/ai-access)。
- 把同樣的檢查接進 CI：[CI 範本](/zh-Hant/docs/workflows/ci-templates)。
