...
這張表隨 `extension-develop/contract/codes.json` 一起發布，參見 [結果信封](/zh-Hant/docs/contracts/result-envelope)。
...
- 在 [結果信封](/zh-Hant/docs/contracts/result-envelope) 中了解錯誤碼會流經哪些地方。
- 在 [生命週期串流](/zh-Hant/docs/contracts/lifecycle-stream) 中即時觀察失敗訊框。
