...
<Frame>
  <iframe
    ...
    src="https://www.youtube-nocookie.com/embed/G4ZpYlCo_AI?rel=0"
...
<Frame>
  <iframe
    className="w-full aspect-video rounded-xl"
    src="https://www.youtube-nocookie.com/embed/QWqpVQ_Gz8Q?rel=0"
...
- 在 [`dev`](/zh-Hant/docs/commands/dev#automation-metadata-recommended-for-scriptsagents) 了解 `doctor` 的起點——就緒契約。
- 透過 [除錯](/zh-Hant/docs/debugging) 從健康的工作階段串流讀取擴充功能記錄。
- 在 [全域 flag](/zh-Hant/docs/workflows/global-flags) 查看共用 flag。
