...
- 把這個建置透過一個連結交給別人審閱，參見 [Share an unpublished build for review](https://docs.extension.dev/share/unpublished-build-for-review)。
- 把產物提交到瀏覽器商店，參見 [extension.dev 發布文件](https://docs.extension.dev/publish/overview)。
