...
從 4.1.20 起，Safari 工作階段就是一個完整的 dev 工作階段。你在 Safari 設定中啟用擴充功能之後,`extension logs` 可以讀取它,控制通道會接上,而且每次儲存都會在 Safari 中重新載入擴充功能。請見 [建置 Safari 擴充功能](/zh-Hant/docs/browsers/safari)。
