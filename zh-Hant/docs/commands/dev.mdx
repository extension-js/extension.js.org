...
`--no-browser` 是無頭、CI 與遠端工作的執行模式,也是 [Playwright E2E](/docs/workflows/playwright-e2e) 工作流程所依賴的旗標。它還有設定寫法 `commands.dev.noBrowser: true`,以及環境變數寫法 `EXTENSION_CLI_NO_BROWSER=1`。
