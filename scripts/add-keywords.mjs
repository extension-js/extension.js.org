...
const STOPWORDS = new Set([
  'the', 'a', 'an', 'and', 'or', 'but', 'if', 'of', 'for', 'to', 'in', 'on', 'at', 'by',
  'from', 'with', 'as', 'is', 'are', 'was', 'were', 'be', 'been', 'being', 'have', 'has',
  'had', 'do', 'does', 'did', 'will', 'would', 'could', 'should', 'may', 'might', 'can',
  'you', 'your', 'we', 'our', 'it', 'its', 'this', 'that', 'these', 'those', 'how', 'what',
  'when', 'where', 'why', 'who', 'which', 'about', 'into', 'over', 'under', 'up', 'down',
  'out', 'off', 'not', 'no', 'yes', 'all', 'any', 'each', 'some', 'more', 'most', 'less',
  'than', 'then', 'so', 'also', 'just', 'only', 'very', 'too', 'here', 'there', 'use',
  'using', 'make', 'makes', 'get', 'gets', 'one', 'two', 'run', 'runs', 'working', 'works'
])

// Words always worth keeping for SEO in this domain
const DOMAIN_ALWAYS = [
  'extension.js', 'extensions', 'chrome', 'firefox', 'edge', 'browser', 'manifest',
  'typescript', 'javascript', 'react', 'vue', 'svelte', 'preact', 'rspack', 'hmr',
  'tailwindcss', 'postcss', 'eslint', 'prettier', 'stylelint', 'playwright', 'webassembly',
  'content script', 'service worker', 'side panel', 'popup', 'devtools'
]
