...
const heroLogoBottomRow = [
  ...
  {
    src: "https://media.extension.land/logos/browsers/samsung-internet.svg",
    className:
      "w-full max-w-[7.625rem] origin-bottom scale-[.83] overflow-hidden rounded-[20%] border border-stone-950 bg-white shadow-[inset_0_1px_1px_0_var(--color-stone-700)]",
  },
];
...
export default function OpenSourceHeroSection() {
  return (
    <section className="relative w-full bg-background" id="open-source">
      <div className="relative z-20 w-full p-4 sm:p-6 md:p-8 lg:p-8">
